...
# Basic Abilities
execute at @p[tag=Brad,scores={Attack=1..}] as @e[distance=..6,limit=1,sort=nearest,tag=!Brad,nbt={HurtTime:10s}] at @s run function datapack:brad_functions/punch
scoreboard players add @p[tag=Brad,tag=!BradBusterPunches,tag=!BradMachineGunFist,tag=!BradCry,tag=!BradHorsestance,tag=!BradJoy,scores={Attack=1..}] Timer6 1
scoreboard players add @p[tag=Brad,tag=!BradBusterPunches,tag=!BradMachineGunFist,tag=!BradCry,tag=!BradHorsestance,tag=!BradJoy,scores={Attack=1..}] Timer9 1

scoreboard players add @p[tag=Brad,scores={Ability1CD=..29}] Ability1CD 1
execute as @p[tag=Brad,scores={COS=1..}] as @p[tag=Brad,scores={Ability1CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Sweaty Wristbands","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:brad_functions/weapon1cos

scoreboard players add @p[tag=Brad,scores={Ability2CD=..29}] Ability2CD 1
execute as @p[gamemode=!spectator,tag=Brad,scores={Shift=1..}] as @p[tag=Brad,scores={Ability2CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Sweaty Wristbands","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:brad_functions/weapon1shift
...
execute as @p[tag=Brad,scores={Timer8=2}] as @p[tag=Brad,scores={Timer7=1}] at @s run summon armor_stand ^ ^ ^1 {Tags:["BradsFireball","projectile"],DisabledSlots:2039583,NoGravity:1b,Invisible:1,Invulnerable:1,ArmorItems:[{},{},{},{id:"minecraft:orange_concrete_powder",Damage:3,Count:1b}]}
...
execute at @e[type=armor_stand,tag=BradsFireball] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brad,tag=!InLabyrinth] at @s run function datapack:brad_functions/fireball
...
execute as @p[tag=Brad,scores={Timer6=1}] as @p[tag=Brad,scores={Timer8=2}] at @s as @e[distance=..40,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brad,tag=!InLabyrinth] at @s run function datapack:brad_functions/scream


# Brad Move 7: 2 on Punch + 1 on Zipper - Surprise Attack
execute as @p[tag=Brad,scores={Timer6=2}] as @p[tag=Brad,scores={Timer7=1}] at @s as @e[distance=..8,sort=nearest,limit=1,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brad,tag=!InLabyrinth] at @s run function datapack:brad_functions/surpriseattack
...
execute at @p[tag=BradJoy,scores={Attack=1..}] run effect give @e[distance=..8,limit=1,sort=nearest,nbt={HurtTime:10s},tag=!Brad] minecraft:poison 2 9 true
