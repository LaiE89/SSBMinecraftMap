...
execute as @p[gamemode=!spectator,tag=Ryze,scores={Ability2CD=100..}] as @p[tag=Ryze,scores={Timer2=15..}] as @p[scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ryze\'s Scroll","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ryze_functions/weapon2shift
...
execute as @p[tag=Ryze,scores={Ability1CD=80..},gamemode=!spectator,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ryze\'s Book","italic":false,"color":"dark_aqua"}]'}}}}] as @p[tag=Ryze,scores={COS=1..}] at @s run function datapack:ryze_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Ryze,scores={Ability3CD=20..}] as @p[tag=Ryze,scores={Timer2=10..}] as @p[scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ryze\'s Scroll","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ryze_functions/weapon2cos
...
execute as @p[tag=Ryze,gamemode=!spectator,scores={Shift=1..}] as @p[tag=Ryze,scores={Ability4CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ryze\'s Book","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ryze_functions/weapon1shift
