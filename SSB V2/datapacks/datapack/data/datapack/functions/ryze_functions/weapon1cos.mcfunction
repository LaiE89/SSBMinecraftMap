summon armor_stand ^ ^ ^1 {Tags:["overload","projectile"],NoGravity:1b,Invisible:1,DisabledSlots:2096896,Invulnerable:1,ArmorItems:[{},{},{},{id:"minecraft:light_blue_glazed_terracotta",Damage:3,Count:1b}]}
