...
# Pulse Pistols
execute as @p[tag=Tracer,tag=!TracerReload,tag=!TracerRecall,scores={Ability5CD=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Pulse Pistols","italic":false,"color":"aqua"}]'}}}}] as @p[tag=Tracer,scores={COS=1..}] at @s run function datapack:tracer_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Tracer,tag=!TracerBlinkCD,tag=!TracerRecall,scores={Ability4CD=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Pulse Pistols","italic":false,"color":"aqua"}]'}}}}] as @p[tag=Tracer,scores={Shift=1..}] at @s run function datapack:tracer_functions/weapon1shift
...
execute as @p[tag=Tracer,scores={Ability2CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Tracer\'s Technology","italic":false,"color":"aqua"}]'}}}}] as @p[tag=Tracer,scores={COS=1..}] at @s run function datapack:tracer_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Tracer,tag=!TracerRecall,scores={Ability3CD=500..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Tracer\'s Technology","italic":false,"color":"aqua"}]'}}}}] as @p[tag=Tracer,scores={Shift=1..}] at @s run function datapack:tracer_functions/weapon2shift

execute at @e[type=armor_stand,tag=TracerPulseBomb] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Tracer,tag=!InLabyrinth] at @s run function datapack:tracer_functions/bombattach
