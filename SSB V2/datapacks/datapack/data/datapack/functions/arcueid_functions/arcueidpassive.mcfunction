...
# Rip Apart
scoreboard players add @p[tag=Arcueid,scores={Attack=1..}] Ability1CD 30
...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Arcueid\'s Claws","italic":false,"color":"dark_purple"}]'}}}}] as @p[tag=Arcueid,scores={Ability1CD=100..}] at @s run function datapack:arcueid_functions/weapon1cos

# Red Arcueid
scoreboard players add @e[tag=Arcueid,scores={Ability2CD=..349}] Ability2CD 1
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Arcueid\'s Claws","italic":false,"color":"dark_purple"}]'}}}}] as @p[tag=Arcueid,scores={Ability2CD=350..}] at @s run function datapack:arcueid_functions/weapon1shift

effect give @p[tag=ArcueidRed,scores={Attack=1..}] regeneration 1 3 true
...
replaceitem entity @p[tag=ArcueidRed,scores={Timer=150..}] armor.head minecraft:player_head{display:{Name:"{\"text\":\"Arcueid\"}"},Enchantments:[{id:protection,lvl:3}],SkullOwner:{Id:[I;839023935,-1429911372,-1641760510,1816825842],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTlhZmZlMWVhYzEwNGFkOGRkYmVmODhhYWFjNWYwYTA3NmMzZTNjNWU4ODZlMDc0ZmE1OThkMjQzZmMxNDdiOCJ9fX0="}]}}} 1
...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Marble Phantasm","italic":false,"color":"dark_purple"}]'}}}}] as @p[tag=Arcueid,scores={Ability3CD=500..}] at @s run function datapack:arcueid_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Marble Phantasm","italic":false,"color":"dark_purple"}]'}}}}] as @p[tag=Arcueid,scores={Ability4CD=1000..}] at @s run function datapack:arcueid_functions/weapon2shift
