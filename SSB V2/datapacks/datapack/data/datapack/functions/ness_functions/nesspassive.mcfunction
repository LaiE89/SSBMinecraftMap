...
execute as @p[gamemode=!spectator,tag=Ness,tag=!NessInThunder,scores={Shift=1..},tag=!NessPKFlash] as @p[tag=Ness,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:stick",tag:{display:{Name:'[{"text":"Baseball Bat","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:ness_functions/weapon1shift
...
execute as @p[tag=Ness,scores={COS=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Psychokinesis","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ness_functions/weapon2cos
...
execute as @e[type=armor_stand,tag=pkfire] at @s if entity @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ness,tag=!InLabyrinth] run function datapack:ness_functions/pkfiredamage
...
execute as @p[gamemode=!spectator,tag=Ness,scores={Shift=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability3CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Psychokinesis","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ness_functions/weapon2shift

execute at @p[tag=NessInThunder] run particle minecraft:dust 0 1 1 1 ~ ~1.5 ~ 0.2 0.2 0.2 0 10

execute at @p[tag=NessInThunder] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ness,tag=!InLabyrinth] at @s run function datapack:ness_functions/pkthunderdamage
...
execute at @p[tag=NessPKRocket] as @e[distance=..3,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ness,tag=!InLabyrinth] at @s run function datapack:ness_functions/pkrocketdamage
...
execute as @p[gamemode=!spectator,tag=Ness,scores={Shift=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability4CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Psionics","italic":false,"color":"dark_green"}]'}}}}] at @s run function datapack:ness_functions/weapon3shift
...
scoreboard players set @p[tag=Ness,scores={Shift=1..}] ShiftOff 0
scoreboard players add @p[tag=Ness,scores={Shift=0}] ShiftOff 1
scoreboard players reset @p[tag=Ness,scores={ShiftOff=2..}] Shift
...
execute if entity @p[tag=NessPKFlash,scores={ShiftOff=2..}] as @e[type=armor_stand,tag=PKFlashBomb] at @s run function datapack:ness_functions/psiflashexplode
execute if entity @p[tag=NessPKFlash,scores={ShiftOff=2..}] run kill @e[type=armor_stand,tag=PKFlashBomb]
execute if entity @p[tag=NessPKFlash,scores={ShiftOff=2..}] run kill @e[type=armor_stand,tag=PKFlashPlace]
effect clear @p[tag=NessPKFlash,scores={ShiftOff=2..}] minecraft:slowness
effect clear @p[tag=NessPKFlash,scores={ShiftOff=2..}] minecraft:weakness
tag @p[tag=NessPKFlash,scores={ShiftOff=2..}] remove NessPKFlash
...
scoreboard players reset @p[tag=Ness,scores={ShiftOff=2..}] ShiftOff

# PSI Lifeup
scoreboard players add @p[tag=Ness,scores={Ability5CD=..199}] Ability5CD 1
execute as @p[tag=Ness,scores={COS=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability5CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Psionics","italic":false,"color":"dark_green"}]'}}}}] at @s run function datapack:ness_functions/weapon3cos