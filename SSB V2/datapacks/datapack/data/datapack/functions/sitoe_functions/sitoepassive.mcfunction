...
# Weapon Wheel
scoreboard players add @p[tag=Sitoe,scores={Shift=0}] ShiftOff 1
scoreboard players reset @p[tag=Sitoe,scores={ShiftOff=3..}] Shift
scoreboard players reset @p[tag=Sitoe,scores={Shift=1..}] ShiftOff

scoreboard players add @p[gamemode=!spectator,tag=Sitoe,scores={Shift=1..},nbt={SelectedItem:{tag:{SitoeWeapon:1b}}}] ShiftOn 1
scoreboard players reset @p[tag=Sitoe,scores={ShiftOff=3..}] ShiftOn

## Weapon Wheel
execute as @p[tag=Sitoe,scores={ShiftOn=1}] at @s run function datapack:sitoe_functions/weaponwheel
execute at @p[tag=Sitoe,scores={ShiftOn=1..}] as @e[type=armor_stand,tag=SitoeWeapons] at @s run tp @s ~ ~ ~ facing entity @p[tag=Sitoe]
execute as @p[tag=Sitoe,scores={ShiftOff=3..}] at @s run kill @e[type=armor_stand,tag=SitoeWeapons]

scoreboard players reset @p[tag=Sitoe,scores={ShiftOff=3..}] ShiftOff

# Sword of Sitrouille
scoreboard players add @p[tag=Sitoe,scores={Attack=1..},nbt={SelectedItem:{id:"minecraft:iron_sword",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Sword of Sitrouille","italic":false,"color":"gold"}]'}}}}] Timer 1
...
execute as @p[tag=Sitoe,tag=!SitoePossessing,scores={Ability1CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Yugioh Cards","italic":false,"color":"dark_red"}]'}}}}] as @s[scores={COS=1..}] at @s run function datapack:sitoe_functions/cardthrow
...
execute as @p[tag=Sitoe,scores={Ability2CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Possession","italic":false,"color":"dark_green"}]'}}}}] as @s[scores={COS=1..}] at @s run function datapack:sitoe_functions/possessionuse
...
tag @e[tag=SitoePossessed,scores={Death=1..}] remove SitoePossessed
...
execute as @p[tag=Sitoe,scores={Ability3CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,SitoeWeapon:1b,display:{Name:'[{"text":"Teleport","italic":false,"color":"dark_purple"}]'}}}}] at @s run execute at @s[scores={COS=1..}] run function datapack:sitoe_functions/teleportuse
execute as @e[type=armor_stand,tag=SitoeBolt] at @s anchored eyes facing entity @e[limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Sitoe,tag=!InLabyrinth] eyes positioned ^ ^ ^4 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^0.5 ^ ^0.5 ~ ~
...
execute at @e[type=armor_stand,tag=SitoeBolt] as @e[distance=..3,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Sitoe,tag=!InLabyrinth] at @s run function datapack:sitoe_functions/teleportdamage

# Ritual
scoreboard players add @p[tag=Sitoe,scores={Ability4CD=..1499}] Ability4CD 1
execute as @p[tag=Sitoe,scores={Ability4CD=1500..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,SitoeWeapon:1b,display:{Name:'[{"text":"Ritual","italic":false,"color":"aqua"}]'}}}}] at @s as @s[scores={COS=1..}] run function datapack:sitoe_functions/ritualuse
...
execute as @p[tag=SitoeGettingRitualed,scores={Death=1..}] run scoreboard players set @e[tag=SitoeRitualStand,type=armor_stand] Timer 149
...
execute as @p[tag=Sitoe,scores={Death=1..}] run tag @e[tag=SitoePossessed] remove SitoePossessed
execute as @p[tag=Sitoe,scores={Death=1..}] run tag @e[tag=SitoeGettingRitualed] remove SitoeGettingRitualed