...
summon armor_stand ~ ~ ~ {Tags:["SitoeBolt","projectile"],Invisible:1b,NoGravity:1b,Invulnerable:1,DisabledSlots:2039583,ArmorItems:[{},{},{},{id:"minecraft:warped_wart_block",Count:1b}]}
