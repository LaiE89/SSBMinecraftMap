...
execute as @p[gamemode=!spectator,tag=Mob,scores={Shift=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Offensive Telekinesis\",\"italic\":false}]"}}}}] at @s run execute as @e[distance=..15,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Mob,tag=!InLabyrinth] at @s run function datapack:mob_functions/weapon1shift

execute as @p[gamemode=!spectator,tag=Mob,scores={Shift=1..},tag=Mob100Percent] as @p[tag=Mob,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Offensive Telekinesis\",\"italic\":false}]"}}}}] at @s run execute as @e[distance=..20,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Mob,tag=!InLabyrinth] at @s run function datapack:mob_functions/weapon1shift100

# Telekinesis
scoreboard players add @p[tag=Mob,scores={Ability2CD=..99}] Ability2CD 1
execute as @p[tag=Mob,scores={COS=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Offensive Telekinesis\",\"italic\":false}]"}}}}] at @s run function datapack:mob_functions/weapon1cos

execute at @p[tag=Mob,scores={COS=1..},tag=Mob100Percent] as @p[tag=Mob,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Offensive Telekinesis\",\"italic\":false}]"}}}}] at @s run function datapack:mob_functions/weapon1cos100
...
execute at @e[type=armor_stand,tag=telekinesis] as @e[distance=..2.5,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Mob,tag=!InLabyrinth] at @s run function datapack:mob_functions/telekinesis
...
execute as @p[gamemode=!spectator,tag=Mob,scores={Shift=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability3CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Defensive Telekinesis\",\"italic\":false}]"},Enchantments:[{id:thorns,lvl:3}],Unbreakable:1}}}] at @s run function datapack:mob_functions/weapon2shift

execute as @p[tag=Mob,scores={Shift=1..},gamemode=!spectator,tag=Mob100Percent] as @p[tag=Mob,scores={Ability3CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Defensive Telekinesis\",\"italic\":false}]"},Enchantments:[{id:thorns,lvl:3}],Unbreakable:1}}}] at @s run function datapack:mob_functions/weapon2shift100
...
execute as @p[tag=Mob,scores={COS=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability4CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Defensive Telekinesis\",\"italic\":false}]"},Enchantments:[{id:thorns,lvl:3}],Unbreakable:1}}}] at @s run function datapack:mob_functions/weapon2cos

execute as @p[tag=Mob,scores={COS=1..},tag=Mob100Percent] as @p[tag=Mob,scores={Ability4CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Defensive Telekinesis\",\"italic\":false}]"},Enchantments:[{id:thorns,lvl:3}],Unbreakable:1}}}] at @s run function datapack:mob_functions/weapon2cos100