...
# Kagune Throw
execute as @p[tag=Kaneki,scores={Ability1CD=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kagune","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={COS=1..}] at @s run function datapack:kaneki_functions/weapon1cos
...
execute if entity @e[type=armor_stand,tag=KanekiKagune] as @p[gamemode=!spectator,tag=Kaneki,scores={Ability4CD=10..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kagune","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Shift=1..}] at @s run function datapack:kaneki_functions/weapon1shift
...
execute if entity @e[type=armor_stand,tag=KanekiKagune] as @p[gamemode=!spectator,tag=Kaneki,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kaneki\'s Skills","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={COS=1..}] at @s run function datapack:kaneki_functions/weapon2cos

# Kakuja
scoreboard players add @p[tag=Kaneki,scores={Ability3CD=..699}] Ability3CD 1
execute as @p[gamemode=!spectator,tag=Kaneki,scores={Ability3CD=700..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kaneki\'s Skills","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Shift=1..}] at @s run function datapack:kaneki_functions/weapon2shift
...
execute as @p[tag=KanekiKakuja,tag=Kaneki] at @s unless entity @s[nbt={Inventory:[{Slot:103b,id:"minecraft:player_head",tag:{display:{Name:"{\"text\":\"Kakuja\"}"}}}]}] run replaceitem entity @s armor.head minecraft:player_head{display:{Name:"{\"text\":\"Kakuja\"}"},Enchantments:[{id:protection,lvl:3}],SkullOwner:{Id:[I;-16977185,811288703,-1145564788,-520051058],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjU0ZWEzNTgzYTBhNmM1NGUxYTI3ZGI2MDI5YjgzMjkwM2Y5MGFiOTZjMTg1YjYwMjkwN2RjNGQxN2VmY2M2MSJ9fX0="}]}}} 1
...
replaceitem entity @p[tag=KanekiKakuja,scores={Timer3=300..}] armor.head minecraft:player_head{display:{Name:"{\"text\":\"Kaneki\"}"},Enchantments:[{id:protection,lvl:3}],SkullOwner:{Id:[I;1541358001,1887784856,-1173820056,-2101818119],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2RlNzQ2YTExZTdkOTY2MjdkMTBiNDc5MGE5MDE2ZjA4YjhiYjkzZjRhNDEzNzFiYTZjNGI0NjJiMzdjZWMwZCJ9fX0="}]}}} 1
