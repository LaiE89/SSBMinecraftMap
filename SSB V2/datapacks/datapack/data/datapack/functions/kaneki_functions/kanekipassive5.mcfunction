...
execute as @s[scores={RaycastTimer=3333..}] positioned ^ ^ ^ run summon armor_stand ~ ~ ~ {Tags:["KanekiKagune"],Small:1b,Invisible:1b,NoGravity:1b,Invulnerable:1,DisabledSlots:2039583}
