...
execute as @p[tag=Brucelee,scores={Ability1CD=100},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Nunchucks","italic":false,"color":"yellow"}]'}}}}] as @p[tag=Brucelee,scores={COS=1..}] at @s run function datapack:brucelee_functions/weapon1cos
...
execute as @p[tag=Brucelee,scores={Ability2CD=150..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Lee\'s Persistence","italic":false,"color":"dark_green"}]'}}}}] as @p[tag=Brucelee,scores={COS=1..}] at @s run function datapack:brucelee_functions/weapon2cos
effect give @p[tag=BruceIronWill,scores={Attack=1..}] minecraft:regeneration 1 3 true
...
execute as @p[gamemode=!spectator,tag=Brucelee,scores={Ability3CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Lee\'s Persistence","italic":false,"color":"dark_green"}]'}}}}] as @p[tag=Brucelee,scores={Shift=1..}] at @s run function datapack:brucelee_functions/weapon2shift
...
execute as @p[gamemode=!spectator,tag=Brucelee,scores={Ability4CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Nunchucks","italic":false,"color":"yellow"}]'}}}}] as @p[tag=Brucelee,scores={Shift=1..}] at @s run function datapack:brucelee_functions/weapon1shift

# Dragon Kick
scoreboard players add @p[tag=Brucelee,scores={Ability5CD=..299}] Ability5CD 1
execute as @p[tag=Brucelee,scores={Ability5CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Dragon Kick","italic":false,"color":"dark_red"}]'}}}}] as @p[tag=Brucelee,scores={COS=1..}] at @s as @e[distance=..6,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brucelee,tag=!InLabyrinth] at @s run function datapack:brucelee_functions/weapon3cos
...
execute at @e[tag=BruceDragonKicked] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brucelee,tag=!BruceDragonKicked,tag=!InLabyrinth] at @s run function datapack:brucelee_functions/dragonkickdamage
