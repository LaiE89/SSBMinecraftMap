...
scoreboard players set @p[tag=Genji,scores={Kills=1..}] Ability2CD 98
...
execute as @p[tag=Genji,scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Genji\'s Shurikens","italic":false}]'}}}}] as @p[tag=Genji,scores={Ability1CD=50..}] at @s run function datapack:genji_functions/weapon1cos
...
execute as @p[tag=Genji,scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Genji\'s Skills","italic":false}]'}}}}] as @p[tag=Genji,scores={Ability2CD=100..}] at @s run function datapack:genji_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Genji,scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Genji\'s Skills","italic":false}]'}}}}] as @p[tag=Genji,scores={Ability3CD=150..}] at @s run function datapack:genji_functions/weapon2shift
...
execute at @e[tag=GenjiDeflectProjectile] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Genji,tag=!InLabyrinth] at @s run function datapack:genji_functions/deflectdamage
execute as @e[tag=GenjiDeflectProjectile] at @s if entity @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Genji,tag=!InLabyrinth] run kill @s
...
execute as @p[tag=Genji,scores={COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Dragonblade","italic":false,"color":"dark_green"}]'}}}}] as @p[tag=Genji,scores={Ability4CD=800..}] at @s run function datapack:genji_functions/weapon3cos
...
# Double Jump
execute as @p[gamemode=!spectator,tag=Genji,nbt={OnGround:0b}] as @p[tag=Genji,scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Genji\'s Shurikens","italic":false}]'}}}}] at @s run tag @s add GenjiDoubleJumping
execute as @p[gamemode=!spectator,tag=Genji,nbt={OnGround:0b}] as @p[tag=Genji,scores={Shift=1..},nbt={SelectedItem:{id:"minecraft:iron_sword",tag:{Unbreakable:1,display:{Name:'[{"text":"Genji\'s Dragonblade","italic":false,"color":"dark_green"}]'}}}}] at @s run tag @s add GenjiDoubleJumping
