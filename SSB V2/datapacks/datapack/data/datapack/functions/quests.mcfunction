# SSB quest
scoreboard players add @a[tag=Player,tag=Quest1,tag=!Quest1Number2Completed,scores={Winner=1}] QuestSSBWins 1
...
execute as @a[tag=Quest1,tag=!Quest1Number2Completed,scores={QuestSSBWins=5..}] at @s run scoreboard players add @s NumLuckyBlocks 1
...
### Quests ###
scoreboard players add @a[tag=InLabyrinth,tag=Quest1,tag=!Quest1Number1Completed,scores={Kills=1}] QuestLabyKills 1
...
execute as @a[tag=Quest1,tag=!Quest1Number1Completed,scores={QuestLabyKills=50..}] at @s run scoreboard players add @s NumLuckyBlocks 1
...
execute as @a[tag=Quest1,tag=!Quest1Number3Completed,scores={QuestBossKill=1..}] at @s run scoreboard players add @s NumLuckyBlocks 1
