...
execute as @a[scores={GetNearestStats=1..}] at @s run execute unless entity @p[distance=2..] run tellraw @s {"text":"No one else is in the server ;(","color":"dark_red"}
execute as @a[scores={GetNearestStats=1..}] at @s run execute if entity @p[distance=2..] run tellraw @s ["",{"text":"-------------------------","color":"white"},{"text":"\n"},{"selector":"@p[distance=2..]","bold":true,"underlined":true,"color":"dark_red"},{"text":"'s Stats","bold":true,"underlined":true,"color":"dark_red"},{"text":"\n\nSSB","bold":true,"color":"dark_red"},{"text":" Stats","bold":true,"color":"yellow"},{"text":"\n"},{"text":"Total Games Played:","color":"green"},{"text":" "},{"score":{"name":"@p[distance=2..]","objective":"SSBGames"}},{"text":"\n"},{"text":"Number of Wins:","color":"aqua"},{"text":" "},{"score":{"name":"@p[distance=2..]","objective":"SSBWins"}},{"text":"\n"},{"text":"Winrate:","color":"red"},{"text":" "},{"score":{"name":"@p[distance=2..]","objective":"SSBWinrate"}},{"text":"%"},{"text":"\n"},{"text":"-------------------------","color":"white"}]
...
# Death Effects
execute if entity @a[tag=goddeatheffect] run function datapack:shop_functions/cosmetics/death_effects/god_death/goddeatheffect
execute if entity @a[tag=goredeatheffect] run function datapack:shop_functions/cosmetics/death_effects/gore_death/goredeatheffect
execute if entity @a[tag=gravedeatheffect] run function datapack:shop_functions/cosmetics/death_effects/grave_death/gravedeatheffect

# Kill Messages
execute if entity @a[tag=godkillmessages] run function datapack:shop_functions/cosmetics/kill_messages/god_kill/godkillmessages
execute if entity @a[tag=terrariakillmessages] run function datapack:shop_functions/cosmetics/kill_messages/terraria_kill/terrariakillmessages
