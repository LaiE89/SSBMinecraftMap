...
execute as @p[gamemode=!spectator,tag=Kiryu,scores={Ability2CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Shift=1..}] at @s run function datapack:kiryu_functions/fightingstyle

### Heat ###
execute as @p[tag=Kiryu,scores={Attack=1..}] at @s run scoreboard players add @s[scores={Timer2=..9}] Timer2 1
...
# Counter
execute as @p[tag=KiryuBrawler,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={COS=1..}] as @p[tag=Kiryu,scores={Timer2=..9}] at @s run function datapack:kiryu_functions/tigerdrop

execute at @p[tag=KiryuCountering,nbt={HurtTime:9s}] as @e[distance=..10,sort=nearest,limit=1,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Kiryu,tag=!InLabyrinth] at @s run function datapack:kiryu_functions/tigerdropdamage
...
# Heat Move (Serenity)
execute as @p[tag=Kiryu,tag=KiryuBrawler,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={COS=1..}] as @p[tag=Kiryu,scores={Timer2=10..}] at @s run function datapack:kiryu_functions/serenity
...
scoreboard players add @p[tag=KiryuRush,scores={Attack=1..}] Ability1CD 50

# Quickstep
execute as @p[tag=KiryuRush,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={COS=1..}] as @p[tag=Kiryu,scores={Timer2=..9}] at @s run function datapack:kiryu_functions/quickstep

# The Knee
execute as @p[tag=KiryuRush,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={COS=1..}] as @p[tag=Kiryu,scores={Timer2=10..}] at @s run function datapack:kiryu_functions/theknee

### Beast ###
# Your first attack pops enemies up
effect give @p[tag=KiryuBeast] minecraft:strength 1 0 true
execute as @p[tag=KiryuBeast,scores={Attack=1..}] as @p[tag=Kiryu,scores={Timer3=1..}] at @s run function datapack:kiryu_functions/beastattack

# Bike Smash
execute as @p[tag=KiryuBeast,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={COS=1..}] at @s run function datapack:kiryu_functions/bikesmash
...
execute as @p[tag=Kiryu,scores={Attack=1..}] at @s if entity @e[tag=KiryuGrabbed] run function datapack:kiryu_functions/wallcrush

execute if entity @e[tag=KiryuGrabbed] run scoreboard players add @p[tag=Kiryu] Timer4 1
execute if entity @p[tag=Kiryu,scores={Death=1..}] run tag @e[tag=KiryuGrabbed] remove KiryuGrabbed
scoreboard players set @p[tag=Kiryu,scores={Death=1..}] Timer4 50
