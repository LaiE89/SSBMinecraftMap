...
execute as @p[tag=Alucard,tag=!AlucardWraith,scores={COS=1..}] as @p[tag=Alucard,scores={Ability1CD=50..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Jackal","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:alucard_functions/weapon1cos
...
execute at @e[type=area_effect_cloud,tag=jackalbullet] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Alucard,tag=!baskerville,tag=!jackalbullet,tag=!InLabyrinth] at @s run function datapack:alucard_functions/jackalbullet
execute as @e[type=area_effect_cloud,tag=jackalbullet] at @s if entity @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Alucard,tag=!baskerville,tag=!jackalbullet,tag=!InLabyrinth] run kill @s
...
execute as @p[tag=Alucard,gamemode=!spectator,scores={Shift=1..}] as @p[tag=Alucard,scores={Ability2CD=400..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Alucard's Dark Arts\",\"italic\":false,\"color\":\"dark_red\"}]"}}}}] at @s run function datapack:alucard_functions/weapon2shift
...
execute as @p[tag=Alucard,tag=!AlucardWraith,gamemode=!spectator,scores={Ability3CD=400..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Alucard's Dark Arts\",\"italic\":false,\"color\":\"dark_red\"}]"}}}}] as @p[tag=Alucard,scores={COS=1..}] at @s run function datapack:alucard_functions/weapon2cos

execute if entity @e[type=armor_stand,tag=baskerville] as @p[gamemode=!spectator,tag=Alucard,scores={Ability3CD=20..150},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Alucard's Dark Arts\",\"italic\":false,\"color\":\"dark_red\"}]"}}}}] as @p[tag=Alucard,scores={COS=1..}] at @s run function datapack:alucard_functions/baskervilleteleport

execute as @e[type=wandering_trader,tag=baskerville] run data remove entity @s HandItems[0]
execute at @e[type=wandering_trader,tag=baskerville] run execute as @e[limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!baskerville,tag=!InLabyrinth,tag=!Alucard] at @s run function datapack:alucard_functions/alucardpassive2
...
execute at @e[type=armor_stand,tag=baskerville,scores={Timer=30..}] as @e[distance=..2.5,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!baskerville,tag=!InLabyrinth,tag=!Alucard] at @s run function datapack:alucard_functions/baskervillebite
...
execute as @p[gamemode=!spectator,tag=Alucard,tag=!AlucardWraith,scores={Ability4CD=25..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Jackal","italic":false,"color":"dark_red"}]'}}}}] as @p[tag=Alucard,scores={Shift=1..}] as @p[tag=Alucard,scores={Timer2=3..}] at @s run function datapack:alucard_functions/weapon1shift
