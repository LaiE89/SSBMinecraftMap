...
execute as @s[scores={kits.raycastTick2=2222..}] as @e[tag=GutsCleaved] at @s run function kits:guts/cleavedamage2
...
execute as @s[scores={kits.raycastTick2=..20}] positioned ^ ^ ^0.5 run function kits:guts/gutspassive3
