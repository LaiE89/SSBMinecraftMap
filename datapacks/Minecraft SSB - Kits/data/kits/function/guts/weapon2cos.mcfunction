...
execute at @s positioned ^ ^1.25 ^1 run execute as @e[distance=1.6..5,type=!#kits:non_entity,tag=!Invincible,tag=!Guts,tag=!InLabyrinth] at @s run function kits:guts/cannondamage
execute at @s positioned ^ ^1.25 ^1 run execute as @e[distance=..1.5,type=!#kits:non_entity,tag=!Invincible,tag=!Guts,tag=!InLabyrinth] at @s run function kits:guts/cannondamage2
...
#execute at @s[nbt={OnGround:0b}] positioned ~ ~1.5 ~ run function kits:guts/gutspassive4
scoreboard players set @s kits.raycastTick3 0
execute at @s positioned ~ ~1.5 ~ run function kits:guts/gutspassive4
