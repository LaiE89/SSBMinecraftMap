...
item replace entity @s armor.chest with leather_chestplate[custom_name={"color":"dark_red","italic":false,"text":"The Black Swordsman\'s Chestplate"},unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"armor.chest.guts",type:"armor",amount:12,operation:"add_value",slot:"chest"},{id:"kb.chest.guts",type:"knockback_resistance",amount:0.5,operation:"add_value",slot:"chest"}],dyed_color=1908001] 1
...
item replace entity @s armor.feet with netherite_boots[custom_name={"color":"dark_red","italic":false,"text":"The Black Swordsman\'s Boots"},unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"speed.feet.guts",type:"movement_speed",amount:0.03,operation:"add_value",slot:"feet"}]] 1
