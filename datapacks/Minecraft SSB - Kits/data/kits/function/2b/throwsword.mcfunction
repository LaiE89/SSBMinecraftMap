...
execute if entity @s[scores={kits.timer=9}] as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!2B,tag=!InLabyrinth] at @s run function kits:2b/throwsworddamage
execute if entity @s[scores={kits.timer=16}] as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!2B,tag=!InLabyrinth] at @s run function kits:2b/throwsworddamage
execute if entity @s[scores={kits.timer=23}] as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!2B,tag=!InLabyrinth] at @s run function kits:2b/throwsworddamage

scoreboard players set @s[tag=2bswordprojectile] kits.raycastTick2 0
execute as @s[tag=2bswordprojectile] positioned ~ ~1.5 ~ run function kits:2b/2bpassive2
tp @s[tag=2bswordprojectile] ^ ^ ^1
tag @s[scores={kits.timer=5..},tag=2bswordprojectile] remove 2bswordprojectile
execute as @s[tag=!2bswordprojectile] unless entity @e[type=area_effect_cloud,tag=2bsworddirec] run function kits:2b/throwsworddirec
