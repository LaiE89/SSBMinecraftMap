...
execute unless score @s kits.dx matches -5..5 if score @s kits.dy matches -5..5 run function kits:siris/blade/magic/track/rot_x
execute if score @s kits.dx matches -5..5 unless score @s kits.dy matches -5..5 run function kits:siris/blade/magic/track/rot_y
execute if score %SirisMagicChanges kits.x matches 1 run function kits:siris/blade/magic/track/changes_x
execute if score %SirisMagicChanges kits.y matches 1 run function kits:siris/blade/magic/track/changes_y
