...
execute if score %SirisMagicDataTemp kits.x matches -3..3 if score %SirisMagicDataTemp kits.dx matches -1..1 run function kits:siris/blade/magic/spells/holy/use
