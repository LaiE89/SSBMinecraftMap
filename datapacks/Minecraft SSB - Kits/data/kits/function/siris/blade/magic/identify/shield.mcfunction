...
execute if score %SirisMagicDataTemp kits.x matches -2..2 if score %SirisMagicDataTemp kits.y matches -2..2 if score %SirisMagicDataTemp kits.dx matches 1 if score %SirisMagicDataTemp kits.dy matches 2 run function kits:siris/blade/magic/spells/shield/use
