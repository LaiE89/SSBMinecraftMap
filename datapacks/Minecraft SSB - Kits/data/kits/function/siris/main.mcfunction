...
# Using Conditions
execute at @s[predicate=kits:items/siris/infinity_blade,gamemode=!spectator] run function kits:siris/blade/use
execute at @s[predicate=kits:items/siris/vile_shield,gamemode=!spectator] run function kits:siris/shield/use
...
execute if score @s kits.timer matches 1.. at @s run function kits:siris/blade/magic/track/main
