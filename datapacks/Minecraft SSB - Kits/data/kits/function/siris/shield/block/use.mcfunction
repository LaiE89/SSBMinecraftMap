...
execute if score @s kits.criterion.COSon matches 1.. run function kits:siris/shield/block/hold
execute if score @s kits.criterion.COSoff matches 1.. run function kits:siris/shield/block/release
