...
execute as @s[scores={kits.raycastTick2=2222}] positioned ^ ^ ^ run execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Ryze,tag=!InLabyrinth] at @s run function kits:ryze/prisondamage
execute as @s[scores={kits.raycastTick2=2222}] run scoreboard players add @s kits.timer3 1
execute as @s[scores={kits.raycastTick2=2222}] run scoreboard players set @s kits.ability1CD 99
...
execute as @s[scores={kits.raycastTick2=..15}] positioned ^ ^ ^0.5 run function kits:ryze/ryzepassive3
