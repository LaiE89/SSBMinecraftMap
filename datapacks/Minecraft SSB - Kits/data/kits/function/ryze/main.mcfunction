...
execute as @s[gamemode=!spectator,scores={kits.ability2CD=100..}] as @s[scores={kits.timer2=10..}] as @s[scores={kits.criterion.shift=1..},predicate=kits:items/ryze/scroll] at @s run function kits:ryze/weapon2shift
execute as @e[type=area_effect_cloud,tag=RyzePrison] at @s run function kits:ryze/prison

# Overload
scoreboard players add @s[scores={kits.ability1CD=..99}] kits.ability1CD 1
execute as @s[scores={kits.ability1CD=100..},gamemode=!spectator,predicate=kits:items/ryze/book] as @s[scores={kits.criterion.COS=1..}] at @s[scores={kits.timer2=2..}] run function kits:ryze/weapon1cos
execute as @e[type=area_effect_cloud,tag=overload] at @s run function kits:ryze/overload

# Flux
scoreboard players add @s[scores={kits.ability3CD=..19}] kits.ability3CD 1
execute as @s[gamemode=!spectator,scores={kits.ability3CD=20..}] as @s[scores={kits.timer2=5..}] as @s[scores={kits.criterion.COS=1..},predicate=kits:items/ryze/scroll] at @s run function kits:ryze/weapon2cos
...
execute as @e[tag=RyzeFlux] at @s run function kits:ryze/flux
execute as @e[tag=RyzeFluxTarget] at @s if entity @e[type=area_effect_cloud,tag=RyzeFluxBall,distance=..1] run function kits:ryze/fluxeffects
...
execute as @s[gamemode=!spectator,scores={kits.criterion.shift=1..}] as @s[scores={kits.ability4CD=300..},predicate=kits:items/ryze/book] at @s run function kits:ryze/weapon1shift

execute as @e[type=armor_stand,tag=realmwarp] at @s run function kits:ryze/realmwarp
execute as @e[type=armor_stand,tag=realmwarp2] at @s run function kits:ryze/realmwarp2
