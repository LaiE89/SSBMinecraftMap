...
execute at @s[scores={kits.timer=..40}] as @e[distance=..2,type=!#kits:non_entity,tag=!Invincible,tag=!Ekko,tag=!InLabyrinth,tag=!EkkoTimeWinderHit] at @s run function kits:ekko/winder

execute if entity @s[scores={kits.timer=41}] run tag @e[tag=EkkoTimeWinderHit] remove EkkoTimeWinderHit

execute at @s[scores={kits.timer=41..}] as @e[distance=..2,type=!#kits:non_entity,tag=!Invincible,tag=!Ekko,tag=!InLabyrinth,tag=!EkkoTimeWinderHit2] at @s run function kits:ekko/winder2

execute at @s[scores={kits.timer=41..}] facing entity @p[tag=Ekko] feet run teleport @s ^ ^ ^2
execute at @s[scores={kits.timer=41..}] if entity @p[tag=Ekko,distance=..2] run function kits:ekko/winderreturn
