...
execute as @s[scores={kits.criterion.shift=1..},gamemode=!spectator] as @s[scores={kits.ability1CD=200..},predicate=kits:items/tanjiro/blade] at @s run function kits:tanjiro/weapon1shift

execute as @s[tag=!TanjiroFiregod,tag=TanjiroConstantFlux] at @s run function kits:tanjiro/constantflux

execute as @s[tag=TanjiroFiregod,tag=TanjiroConstantFlux] at @s positioned ~ ~1 ~ run function kits:tanjiro/hinokamikagura
...
execute as @s[scores={kits.criterion.COS=1..}] as @s[tag=!TanjiroFiregod,scores={kits.ability2CD=100..},predicate=kits:items/tanjiro/water] at @s run function kits:tanjiro/waterwheel

execute as @s[scores={kits.criterion.COS=1..}] as @s[tag=TanjiroFiregod,scores={kits.ability2CD=100..},predicate=kits:items/tanjiro/water] at @s run function kits:tanjiro/clearbluesky

# Water Surface Slash
scoreboard players add @s[scores={kits.ability3CD=..49}] kits.ability3CD 1
execute as @s[scores={kits.criterion.shift=1..},gamemode=!spectator] as @s[tag=!TanjiroFiregod,scores={kits.ability3CD=50..},predicate=kits:items/tanjiro/water] at @s run function kits:tanjiro/watersurfaceslash

execute as @s[scores={kits.criterion.shift=1..},gamemode=!spectator] as @s[tag=TanjiroFiregod,scores={kits.ability3CD=50..},predicate=kits:items/tanjiro/water] at @s run function kits:tanjiro/ragingsun 

# Firegod
scoreboard players add @s[scores={kits.ability4CD=..699}] kits.ability4CD 1
execute as @s[scores={kits.criterion.COS=1..}] as @s[scores={kits.ability4CD=700..},predicate=kits:items/tanjiro/sun] at @s run function kits:tanjiro/firegod
