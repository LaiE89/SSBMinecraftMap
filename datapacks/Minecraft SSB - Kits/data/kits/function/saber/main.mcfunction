...
execute as @s[tag=SaberStrikeAir,scores={kits.timer=10..}] as @s[tag=SaberStrikeAir,gamemode=!spectator,scores={kits.criterion.shift=1..},predicate=kits:items/saber/air] at @s run function kits:saber/strikeair
...
execute as @s[tag=SaberStrikeAir2,scores={kits.timer2=10..}] as @s[tag=SaberStrikeAir2,gamemode=!spectator,scores={kits.criterion.shift=1..},predicate=kits:items/saber/air] at @s run function kits:saber/strikeair2
...
execute as @s[scores={kits.ability2CD=150..},predicate=kits:items/saber/air] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:saber/weapon1cos

# Avalon
scoreboard players add @s[scores={kits.ability3CD=..299}] kits.ability3CD 1
execute as @s[scores={kits.ability3CD=300..},predicate=kits:items/saber/avalon] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:saber/weapon2cos

# Excalibur
scoreboard players add @s[scores={kits.ability4CD=..599}] kits.ability4CD 1
execute as @s[scores={kits.ability4CD=600..},predicate=kits:items/saber/avalon] as @s[gamemode=!spectator,scores={kits.criterion.shift=1..}] at @s run function kits:saber/weapon2shift
...
give @s[tag=SaberExcalibur,scores={kits.timer3=200..}] carrot_on_a_stick[custom_name={"color":"dark_aqua","italic":false,"text":"Invisible Air"},lore=[[""],[{"color":"aqua","italic":false,"text":"Valor:"},{"color":"dark_purple","text":" "},{"color":"yellow","text":"RIGHT CLICK"}],{"color":"gray","italic":false,"text":"Dash forward and gain absorption."},[""],[{"color":"aqua","italic":false,"text":"Strike Air:"},{"color":"dark_purple","text":" "},{"color":"yellow","text":"SHIFT"}],{"color":"gray","italic":false,"text":"You can cast this 3 times. Each"},{"color":"gray","italic":false,"text":"cast causes you to dash forwards"},{"color":"gray","italic":false,"text":"and deal damage around you. You also"},{"color":"gray","italic":false,"text":"gain resistance for a short time."},{"color":"gray","italic":false,"text":"The third cast does the most damage."}],unbreakable={},custom_model_data={floats:[22]},custom_data={KitItem:1b},attribute_modifiers=[{id:"damage.mainhand.saber",type:"attack_damage",amount:5,operation:"add_value",slot:"mainhand"},{id:"speed.mainhand.saber",type:"attack_speed",amount:20,operation:"add_value",slot:"mainhand"}]] 1
