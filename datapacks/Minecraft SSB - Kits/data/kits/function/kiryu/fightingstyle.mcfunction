execute as @s[tag=KiryuBrawler,tag=!KiryuRush,tag=!KiryuBeast] run function kits:kiryu/rush
execute as @s[tag=KiryuRush,tag=!KiryuBrawler,tag=!KiryuBeast] run function kits:kiryu/beast
execute as @s[tag=KiryuBeast,tag=!KiryuBrawler,tag=!KiryuRush] run function kits:kiryu/brawler
