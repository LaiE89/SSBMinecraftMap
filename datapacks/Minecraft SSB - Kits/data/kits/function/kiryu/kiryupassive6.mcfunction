...
execute as @s[scores={kits.raycastTick=2222}] positioned ^ ^ ^ run execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Kiryu,tag=!InLabyrinth] at @s run function kits:kiryu/thekneedamage
...
execute as @s[scores={kits.raycastTick=..30}] positioned ^ ^ ^0.5 run function kits:kiryu/kiryupassive6
