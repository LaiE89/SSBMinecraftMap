...
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run summon area_effect_cloud ~ ~ ~ {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:5,Tags:["EdwardExplosionLocation"]}
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run execute as @e[distance=..4,type=!#kits:non_entity,tag=!Invincible,tag=!Edward,tag=!InLabyrinth] at @s run function kits:edward/deconstructexplosion
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run function kits:edward/deconstructdebris
...
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run execute at @s rotated ~ 0 run function kits:edward/circleparticles2
...
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run scoreboard players reset @s kits.timer3
execute as @s[scores={kits.raycastTick=2222}] positioned ~ ~ ~ run effect clear @s minecraft:strength
...
execute as @s[scores={kits.raycastTick=3333}] positioned ~ ~ ~ run execute at @s rotated ~ 0 run function kits:edward/circleparticles2
...
execute as @s[scores={kits.raycastTick=3333}] positioned ~ ~ ~ run scoreboard players reset @s kits.timer3
execute as @s[scores={kits.raycastTick=3333}] positioned ~ ~ ~ run effect clear @s minecraft:strength
execute as @s[scores={kits.raycastTick=3333}] positioned ~ ~ ~ run scoreboard players set @s kits.ability3CD 0

execute as @s[scores={kits.raycastTick=4444}] positioned ~ ~ ~ run function kits:edward/wallexplode
execute as @s[scores={kits.raycastTick=..15}] positioned ^ ^ ^0.5 run function kits:edward/deconstruct
