...
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run schedule function kits:edward/cagesummon 10t append
...
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run execute at @s rotated ~ 0 run function kits:edward/circleparticles
...
execute as @s[scores={kits.raycastTick=..29}] positioned ^ ^ ^0.5 run function kits:edward/cagelocation
