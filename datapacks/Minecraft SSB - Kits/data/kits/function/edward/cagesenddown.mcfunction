...
execute if entity @s[scores={kits.raycastTick=2222..}] run function kits:edward/cagesummon4
execute as @s[scores={kits.raycastTick=..1111}] positioned ~ ~-0.5 ~ run function kits:edward/cagesenddown
