...
execute if entity @s[scores={kits.criterion.COS=1..},predicate=kits:items/raiden/murasama] if entity @s[scores={kits.timer2=4..}] run function kits:raiden/blademodeslash
