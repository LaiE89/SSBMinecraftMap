...
execute as @s[scores={kits.raycastTick=2222..}] positioned ^ ^ ^ as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!Raiden,tag=!InLabyrinth] at @s run function kits:raiden/damage
execute if entity @s[scores={kits.raycastTick=21}] at @s as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!Raiden,tag=!InLabyrinth] at @s run function kits:raiden/damage

execute as @s[scores={kits.raycastTick=..20}] rotated ~ 0 positioned ^ ^ ^0.5 run function kits:raiden/raidenpassive2
