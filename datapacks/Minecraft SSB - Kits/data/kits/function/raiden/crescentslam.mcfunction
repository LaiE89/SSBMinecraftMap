...
execute as @s at @s positioned ~ ~ ~ run function kits:raiden/raidenpassive3
scoreboard players set @e[tag=RaidenCrescentSliced] kits.specific.raidenCrescentTick 0
execute as @e[tag=RaidenCrescentSliced] at @s positioned ~ ~ ~ run function kits:raiden/raidenpassive4
