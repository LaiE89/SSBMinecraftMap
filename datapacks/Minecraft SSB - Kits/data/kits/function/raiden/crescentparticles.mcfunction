...
particle dust{color:[0.502,0.502,0.502],scale:1} ^ ^1.5 ^1.5 0 0 0 0 1 force
...
tp @s ~ ~ ~ ~ ~-5
execute unless entity @s[x_rotation=-90] at @s run function kits:raiden/crescentparticles
