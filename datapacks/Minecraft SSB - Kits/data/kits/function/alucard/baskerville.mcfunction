...
execute if entity @s[scores={kits.timer=30..}] as @e[distance=..2.5,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!AlucardBaskerville,tag=!InLabyrinth,tag=!Alucard] at @s run function kits:alucard/baskervillebite
