...
execute positioned ~ ~1.5 ~ run function kits:doomfist/doomfistpassive6
...
execute if entity @e[type=minecraft:area_effect_cloud,distance=..3,tag=rocketpunch] run function kits:doomfist/rocketpunchend2
