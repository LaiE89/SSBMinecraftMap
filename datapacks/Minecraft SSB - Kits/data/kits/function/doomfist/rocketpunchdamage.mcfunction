...
execute if entity @p[tag=Doomfist,tag=!DoomfistMax] as @p[tag=Doomfist] at @s run function kits:doomfist/bestdefense
...
execute as @p[tag=Doomfist] at @s positioned ~ ~0.5 ~ run function kits:doomfist/doomfistpassive9
