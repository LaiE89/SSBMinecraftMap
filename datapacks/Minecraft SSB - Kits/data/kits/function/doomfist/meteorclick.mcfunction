...
execute at @s run function kits:doomfist/doomfistpassive5
effect clear @s minecraft:levitation
execute at @s run execute as @e[distance=..8,type=!#kits:non_entity,tag=!Invincible,tag=!Doomfist,tag=!InLabyrinth] at @s run function kits:doomfist/meteordamage
