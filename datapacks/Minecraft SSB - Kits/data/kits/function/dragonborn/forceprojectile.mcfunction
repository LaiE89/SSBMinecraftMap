...
execute as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!InLabyrinth,tag=!Dragonborn,tag=!DragonbornForceDamage] at @s run function kits:dragonborn/forcedamage
