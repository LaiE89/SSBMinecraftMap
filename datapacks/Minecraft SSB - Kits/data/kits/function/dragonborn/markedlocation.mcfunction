...
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run execute at @s positioned ~ ~1.5 ~ positioned ^ ^ ^1.5 run function kits:dragonborn/boom
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run execute at @s run scoreboard players set @s kits.ability1CD 0

execute as @s[scores={kits.raycastTick=..99}] positioned ^ ^ ^0.5 run function kits:dragonborn/markedlocation
