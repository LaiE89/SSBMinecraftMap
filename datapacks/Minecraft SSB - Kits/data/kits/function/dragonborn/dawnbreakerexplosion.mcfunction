...
function kits:dragonborn/expanding_sphere/play {"Inaccuracy":"150","Speed":"200","Limit":"4","R":"0","G":"70","B":"90","Size":"75"}
...
execute as @e[distance=..7,type=!#kits:non_entity,tag=!Invincible,tag=!InLabyrinth,tag=!Dragonborn] at @s run function kits:dragonborn/dawnbreakerdamage
