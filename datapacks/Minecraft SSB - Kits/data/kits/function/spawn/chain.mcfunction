execute at @s positioned ~ ~ ~ facing entity @p[tag=Spawn] feet run function kits:spawn/spawnpassive5
...
execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Spawn,tag=!InLabyrinth] at @s run function kits:spawn/chainsdamage
