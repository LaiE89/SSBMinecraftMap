...
execute as @s[scores={kits.raycastTick=2222}] run function kits:laieth/possessionactivate
execute as @s[scores={kits.raycastTick=..20}] positioned ^ ^ ^0.5 run function kits:laieth/laiethpassive2
