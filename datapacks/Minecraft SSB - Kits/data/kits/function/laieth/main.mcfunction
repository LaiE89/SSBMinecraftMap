...
execute at @s anchored eyes run function kits:laieth/weaponwheelfacing

# Weapon Wheel
scoreboard players add @s[scores={kits.criterion.shift=0}] kits.criterion.shiftOff 1
scoreboard players reset @s[scores={kits.criterion.shiftOff=3..}] Shift
...
## Weapon Wheel
execute as @s[scores={kits.criterion.shiftOn=1}] at @s anchored eyes run function kits:laieth/weaponwheel
...
execute as @s[scores={kits.timer=3..}] at @s run function kits:laieth/swordhit
...
execute as @s[tag=!LaiethPossessing,scores={kits.ability1CD=100..},predicate=kits:items/laieth/cards] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:laieth/yugiohuse

# Orichalcos
scoreboard players add @e[type=area_effect_cloud,tag=LaiethOrichalcos] kits.timer 1
execute as @e[type=area_effect_cloud,tag=LaiethOrichalcos,scores={kits.timer=10..}] at @s run function kits:laieth/cards/orichalcosparticles

# Solemn Strike
execute as @s[scores={kits.timer7=1..}] at @s run function kits:laieth/lightning/main
execute as @e[type=!#kits:non_entity,tag=!Invincible,tag=!Laieth,tag=!InLabyrinth] at @s if score @s kits.specific.laiethStun matches 1.. run function kits:laieth/cards/solemnstrikestun

# Traps
execute as @s[scores={kits.criterion.damage=1..}] at @s run function kits:laieth/cards/activatetraps

# Possession
scoreboard players add @s[scores={kits.ability2CD=..299}] kits.ability2CD 1
execute as @s[scores={kits.ability2CD=300..},predicate=kits:items/laieth/possession] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:laieth/possessionuse
execute as @s[tag=LaiethPossessing] at @s run function kits:laieth/possessionmain

# Teleport
scoreboard players add @s[scores={kits.ability3CD=..299}] kits.ability3CD 1
execute as @s[scores={kits.ability3CD=300..},predicate=kits:items/laieth/teleport] at @s run execute at @s[scores={kits.criterion.COS=1..}] run function kits:laieth/teleportuse
execute as @e[type=area_effect_cloud,tag=LaiethBolt] at @s run function kits:laieth/teleportbolt

# Ritual
scoreboard players add @s[scores={kits.ability4CD=..1499}] kits.ability4CD 1
execute as @s[scores={kits.ability4CD=1500..},predicate=kits:items/laieth/ritual] at @s as @s[scores={kits.criterion.COS=1..}] run function kits:laieth/ritualuse
execute as @e[type=area_effect_cloud,tag=LaiethRitualStand] at @s run function kits:laieth/ritualmain
