...
# Collision
execute if entity @e[distance=..1.75,limit=1,sort=nearest,tag=!Jacket,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] run function kits:jacket/shotgun/hit
