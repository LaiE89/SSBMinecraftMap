## When Throw Is Used
# Throws item
summon area_effect_cloud ~ ~ ~ {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:20,Tags:["JacketThrowItemTasks","JacketProjectile","projectile"]}
