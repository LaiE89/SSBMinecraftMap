...
execute as @e[distance=..1.5,limit=1,sort=nearest,tag=!Jacket,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] at @s run function kits:jacket/throw/hit2
