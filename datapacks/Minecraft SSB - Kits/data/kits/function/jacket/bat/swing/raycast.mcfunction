...
execute as @e[tag=JacketBatSwingCollided] at @s run function kits:jacket/bat/swing/collision
...
# Loop
execute as @s[scores={kits.raycastTick=..12}] positioned ^ ^ ^0.5 run function kits:jacket/bat/swing/raycast
