...
# draw
tp @s ~ ~ ~ 0 -90
execute if score %VFXExpandingSphereIterations kits.z < %VFXExpandingSphereLimit kits.constant at @s run function kits:char/doomslayer/expanding_sphere/draw_sphere with storage kits:vfx ExpandingSphere
execute if score %VFXExpandingSphereIterations kits.z >= %VFXExpandingSphereLimit kits.constant run function kits:char/doomslayer/expanding_sphere/expanding_sphere/end
