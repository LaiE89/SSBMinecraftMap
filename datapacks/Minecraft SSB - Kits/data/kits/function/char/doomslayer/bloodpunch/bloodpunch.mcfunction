...
execute positioned ~ ~1.25 ~ run function kits:char/doomslayer/slash_crescent/play {"concavity":"400","thickness":"7","accuracy":"50","yaw":"90","pitch":"0","distance":"5","particle":"dust{color:[1.500,0.000,0.000],scale:1}"}
