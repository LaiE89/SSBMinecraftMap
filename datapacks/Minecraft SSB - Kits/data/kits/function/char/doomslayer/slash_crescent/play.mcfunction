# example call: function kits:char/doomslayer/slash_crescent/play {"concavity":"400","thickness":"5","accuracy":"50","yaw":"90","pitch":"0","distance":"5","particle":"flame"}
...
# summon
summon area_effect_cloud ~ ~ ~ {Tags:["vfx","VFX_DoomslayerSlashCrescent"],Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:0}
tp @e[type=area_effect_cloud,limit=1,sort=nearest,tag=VFX_DoomslayerSlashCrescent] ~ ~ ~ ~ ~
execute as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=VFX_DoomslayerSlashCrescent] at @s run function kits:char/doomslayer/slash_crescent/get with storage kits:vfx SlashCrescent
function kits:char/doomslayer/slash_crescent/end