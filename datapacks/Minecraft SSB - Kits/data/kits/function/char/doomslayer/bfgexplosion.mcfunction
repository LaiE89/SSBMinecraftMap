...
function kits:char/doomslayer/expanding_sphere/play {"Inaccuracy":"150","Speed":"200","Limit":"5","R":"0","G":"200","B":"0","Size":"200"}
particle flash ~ ~1 ~ 0 0 0 0 5 force
playsound minecraft:entity.generic.explode neutral @a[distance=..50] ~ ~ ~ 2 0 1
execute as @e[distance=..8,type=!#kits:non_entity,tag=!Invincible,tag=!Doomslayer,tag=!InLabyrinth] at @s run damage @s 6 bypass:player_attack by @e[type=armor_stand,tag=DoomslayerBfg,limit=1,sort=nearest] from @p[tag=Doomslayer]
kill @s
