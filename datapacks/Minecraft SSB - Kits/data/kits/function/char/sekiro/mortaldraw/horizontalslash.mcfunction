...
execute positioned ^ ^2 ^2 run function kits:char/sekiro/slash_crescent/play {"concavity":"400","thickness":"7","accuracy":"50","yaw":"90","pitch":"165","distance":"5","particle":"dust{color:[1.500,0.000,0.000],scale:1.5}"}
execute positioned ^ ^2 ^2 run function kits:char/sekiro/slash_crescent/play {"concavity":"400","thickness":"4","accuracy":"50","yaw":"90","pitch":"165","distance":"5","particle":"squid_ink"}
