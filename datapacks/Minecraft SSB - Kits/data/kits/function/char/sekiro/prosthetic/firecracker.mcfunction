...
summon area_effect_cloud ^-0.2 ^ ^1 {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:20,Tags:["SekiroFirecracker","projectile"]}
summon area_effect_cloud ^-0.6 ^ ^1 {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:20,Tags:["SekiroFirecracker","projectile"]}
summon area_effect_cloud ^0.2 ^ ^1 {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:20,Tags:["SekiroFirecracker","projectile"]}
summon area_effect_cloud ^0.6 ^ ^1 {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:20,Tags:["SekiroFirecracker","projectile"]}
