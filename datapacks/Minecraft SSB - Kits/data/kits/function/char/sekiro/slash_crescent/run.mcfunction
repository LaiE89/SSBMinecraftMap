## Runs Crescent Slash
# draw parabola
function kits:char/sekiro/slash_crescent/parabola
execute positioned as @s run function kits:char/sekiro/slash_crescent/draw with storage kits:vfx SlashCrescent
...
execute if score %vfxSlashCrescent.thickness kits.dz matches 1.. if score %vfxSlashCrescent.runItt kits.dz > %vfxSlashCrescent.accuracy kits.constant run function kits:char/sekiro/slash_crescent/thickness
execute unless score %vfxSlashCrescent.runItt kits.dz > %vfxSlashCrescent.accuracy kits.constant run function kits:char/sekiro/slash_crescent/run