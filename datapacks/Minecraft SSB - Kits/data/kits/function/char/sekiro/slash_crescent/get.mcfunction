...
# values with x,y,z
function kits:char/sekiro/slash_crescent/calc_init {"objective":"kits.x"}
function kits:char/sekiro/slash_crescent/calc_init {"objective":"kits.y"}
function kits:char/sekiro/slash_crescent/calc_init {"objective":"kits.z"}
...
## Run
function kits:char/sekiro/slash_crescent/run