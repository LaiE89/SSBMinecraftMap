...
# values with x,y,z
function kits:char/kirito/slash_crescent/calc_init {"objective":"kits.x"}
function kits:char/kirito/slash_crescent/calc_init {"objective":"kits.y"}
function kits:char/kirito/slash_crescent/calc_init {"objective":"kits.z"}
...
## Run
function kits:char/kirito/slash_crescent/run