...
execute as @e[type=area_effect_cloud,tag=KiritoHorizontalSquareAnimation] at @s run function kits:char/kirito/horizontalsquareanimation
...
execute if entity @s[scores={kits.criterion.COS=1..},predicate=kits:items/kirito/dark_repulser] if entity @s[scores={kits.ability3CD=500..}] at @s run function kits:char/kirito/weapon2cos
