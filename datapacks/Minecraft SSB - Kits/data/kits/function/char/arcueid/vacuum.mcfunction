...
execute as @e[distance=..2.5,tag=!Arcueid,tag=!InLabyrinth] at @s run damage @s 1 bypass:player_attack_no_kb by @e[type=area_effect_cloud,tag=ArcueidVacuum,limit=1,sort=nearest] from @p[tag=Arcueid]
