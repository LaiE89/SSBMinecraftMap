...
execute as @s[gamemode=!spectator,scores={kits.criterion.COS=1..},predicate=kits:items/arcueid/marblephantasm] as @s[scores={kits.ability3CD=500..}] at @s run function kits:char/arcueid/weapon2cos
...
execute as @s[gamemode=!spectator,scores={kits.criterion.shift=1..},predicate=kits:items/arcueid/marblephantasm] as @s[scores={kits.ability4CD=1000..}] at @s run function kits:char/arcueid/weapon2shift
