...
execute if entity @s[scores={kits.raycastTick=8}] run tp @s ^ ^ ^

execute as @s[scores={kits.raycastTick=..7}] positioned ^ ^ ^0.5 run function kits:char/saber/saberpassive2
