...
execute positioned ~ ~0.5 ~ run function kits:char/trailblazer/basic/dash
execute positioned as @s as @e[distance=..5,tag=!Trailblazer,tag=!InLabyrinth,type=!#kits:non_entity] at @s run function kits:char/trailblazer/basic/hit
