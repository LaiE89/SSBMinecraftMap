...
execute if entity @p[tag=Luffy] as @e[type=area_effect_cloud,tag=LuffyGrab] at @s positioned ~ ~0.75 ~ facing entity @p[tag=Luffy] feet run function kits:char/luffy/arm/particles
