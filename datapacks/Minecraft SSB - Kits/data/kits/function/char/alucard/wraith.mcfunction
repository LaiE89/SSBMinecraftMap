...
item replace entity @s[scores={kits.timer=100..}] armor.legs with leather_leggings[custom_name={"color":"dark_red","italic":false,"text":"Alucard\'s Pants"},unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"kb.legs.alucard",type:"knockback_resistance",amount:0.8,operation:"add_value",slot:"legs"}],dyed_color=4673362] 1
