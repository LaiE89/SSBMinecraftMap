...
execute at @s facing entity @e[limit=1,sort=nearest,tag=IsaacObjectExplosive,type=armor_stand] feet rotated ~ 0 run function kits:char/isaac/plasma_cutter/explosive_canister/kb
