...
execute as @e[type=area_effect_cloud,tag=EdwardWallLocation,limit=1,sort=nearest] at @s run execute as @e[distance=..7,tag=!Edward,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] at @s run function kits:char/edward/wallexplodedamage
execute as @e[type=area_effect_cloud,tag=EdwardWallLocation,limit=1,sort=nearest] at @s run function kits:char/edward/wallexplodedebris
execute as @e[type=area_effect_cloud,tag=EdwardWallLocation,limit=1,sort=nearest] at @s run function kits:char/edward/wallbreak
