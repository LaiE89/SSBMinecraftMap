...
execute as @s[scores={kits.raycastTick=2222..}] positioned ^ ^ ^-0.5 run function kits:char/edward/wallpunchparticles2
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run tag @s add EdwardCastingWall
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run summon area_effect_cloud ^ ^ ^1.5 {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:15,Tags:["EdwardWallProjectileOrigin"]}
...
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run schedule function kits:char/edward/wallprojectile 10t append

execute as @s[scores={kits.raycastTick=..14}] positioned ^ ^ ^0.5 run function kits:char/edward/wallpunchparticles
