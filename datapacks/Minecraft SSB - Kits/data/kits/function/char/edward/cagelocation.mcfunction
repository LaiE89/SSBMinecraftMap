...
execute as @s[scores={kits.raycastTick=2222..}] positioned ~ ~ ~ run schedule function kits:char/edward/cagesummon 10t append
...
execute as @s[scores={kits.raycastTick=..29}] positioned ^ ^ ^0.5 run function kits:char/edward/cagelocation
