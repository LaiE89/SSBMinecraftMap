...
execute as @e[type=area_effect_cloud,tag=EdwardWallLocation] at @s run function kits:char/edward/walleffects
execute as @e[type=armor_stand,tag=EdwardWallProjectile] at @s run function kits:char/edward/wallprojectileeffects
...
execute as @e[type=area_effect_cloud,tag=EdwardCageLocation] at @s run function kits:char/edward/cageeffects
...
execute as @e[type=minecraft:armor_stand,tag=EdwardDebris] at @s run function kits:char/edward/debrisdamage
