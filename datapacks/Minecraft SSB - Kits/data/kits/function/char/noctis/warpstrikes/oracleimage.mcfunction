...
execute if score @s kits.timer matches 5 run function kits:char/noctis/warpstrikes/oracleimageparticles
...
#execute if score @s kits.timer3 matches 0 run function kits:char/noctis/warpstrikes/oracleimageparticles

execute positioned ~ ~1 ~ as @e[distance=..1.5,type=!#kits:non_entity,tag=!Invincible,tag=!Noctis,tag=!InLabyrinth] at @s run function kits:char/noctis/warpstrikes/oraclestun
