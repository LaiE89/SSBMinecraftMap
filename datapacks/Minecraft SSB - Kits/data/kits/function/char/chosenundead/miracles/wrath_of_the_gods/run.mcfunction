...
# draw
tp @s ~ ~ ~ 0 -90
execute if score %VFXExpandingSphereIterations kits.z < %VFXExpandingSphereLimit kits.constant at @s run function kits:char/chosenundead/miracles/wrath_of_the_gods/draw_sphere with storage kits:vfx ExpandingSphere
execute if score %VFXExpandingSphereIterations kits.z >= %VFXExpandingSphereLimit kits.constant run function kits:char/chosenundead/miracles/wrath_of_the_gods/end