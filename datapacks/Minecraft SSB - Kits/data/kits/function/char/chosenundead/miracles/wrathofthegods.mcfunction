...
execute as @e[distance=..6,type=!#kits:non_entity,tag=!Invincible,tag=!ChosenUndead,tag=!InLabyrinth] at @s run function kits:char/chosenundead/miracles/wrathofthegodsdamage
