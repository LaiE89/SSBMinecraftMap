...
execute if entity @s[scores={kits.timer=25}] run summon area_effect_cloud ~ ~2 ~ {Tags:["EkkoConvergence","EkkoConvergenceProjectile","projectile"],Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:30}
