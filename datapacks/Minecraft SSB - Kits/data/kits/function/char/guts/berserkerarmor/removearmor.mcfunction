...
item replace entity @s armor.feet with netherite_boots[custom_name={"color":"dark_red","italic":false,"text":"The Black Swordsman\'s Boots"},unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"speed.feet.guts",type:"movement_speed",amount:0.01,operation:"add_value",slot:"feet"}]] 1
