...
execute if score @s kits.timer3 matches 15.. run execute as @e[distance=..5,type=!#kits:non_entity,tag=!Invincible,tag=!Cynthia,tag=!InLabyrinth] at @s run damage @s 4 bypass:player_attack by @p[tag=Cynthia]
