...
execute positioned ~ ~-0.5 ~ run function kits:char/kaneki/kaguneparticles
...
execute as @s[scores={kits.raycastTick=15}] positioned ^ ^ ^ run function kits:char/kaneki/kagunedown

execute as @s[scores={kits.raycastTick=..14}] positioned ^ ^ ^0.5 run function kits:char/kaneki/kanekipassive2
