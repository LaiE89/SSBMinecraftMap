...
execute as @s[gamemode=!spectator,tag=Kaneki,scores={kits.ability2CD=100..},predicate=kits:items/kaneki/skills] as @s[scores={kits.criterion.COS=1..}] at @s if entity @e[type=area_effect_cloud,tag=KanekiKagune] run function kits:char/kaneki/weapon2cos
