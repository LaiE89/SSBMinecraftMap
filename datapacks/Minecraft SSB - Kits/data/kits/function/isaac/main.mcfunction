...
## Cooldowns
# Recharge cooldowns
execute if score @s kits.ability3CD matches 200.. run function kits:isaac/plasma_cutter/explosive_canister/gain_charge
execute if score @s kits.ability5CD matches 300.. run function kits:isaac/modules/stasis/gain_charge
...
## Using Conditions
execute if entity @s[scores={kits.criterion.attack=1..}] as @e[nbt={HurtTime:10s},limit=1,sort=nearest] at @s run function kits:isaac/attack
execute if entity @s[predicate=kits:items/isaac/plasma_cutter,gamemode=!spectator] at @s run function kits:isaac/plasma_cutter/use
execute if entity @s[predicate=kits:items/isaac/modules,gamemode=!spectator] at @s run function kits:isaac/modules/use

## Assigns Tasks to Entities
execute as @e[type=area_effect_cloud] at @s run function kits:isaac/assign_tasks/to_aecs
execute as @e[type=armor_stand] at @s run function kits:isaac/assign_tasks/to_armorstands
