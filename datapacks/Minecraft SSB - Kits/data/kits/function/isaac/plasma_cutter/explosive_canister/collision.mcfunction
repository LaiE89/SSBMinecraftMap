...
execute as @e[distance=..10,tag=!Isaac,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] at @s run function kits:isaac/plasma_cutter/explosive_canister/hit
...
# Particles
function kits:isaac/plasma_cutter/explosive_canister/expanding_sphere/play {"Inaccuracy":"50","Speed":"100","Limit":"10","R":"99","G":"29","B":"1","Size":"50"}
