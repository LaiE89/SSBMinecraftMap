...
particle minecraft:flash ~ ~1 ~ 0 0 0 0 50 force
...
execute as @e[type=area_effect_cloud,tag=LuffyPistol,tag=!ChargingLuffyPistol] at @s positioned ~ ~1.5 ~ run function kits:luffy/pistol/knockback {"Distance":"30"}