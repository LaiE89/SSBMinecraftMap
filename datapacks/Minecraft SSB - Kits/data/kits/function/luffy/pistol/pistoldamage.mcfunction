...
function kits:_main/calc/distance
...
execute if score %sqrt.out kits.math matches 2500.. run function kits:luffy/pistol/damagebig
execute if score %sqrt.out kits.math matches 1000..2499 run function kits:luffy/pistol/damagemedium
execute if score %sqrt.out kits.math matches ..999 run function kits:luffy/pistol/damagesmall

tag @e[tag=LuffyKB] remove LuffyKB
execute as @e[type=area_effect_cloud,tag=LuffyPistol] run function kits:luffy/pistol/pistolending