...
# Haki
function kits:luffy/haki/haki 

# Pistol
scoreboard players add @s[scores={kits.ability1CD=..99}] kits.ability1CD 1
execute as @s[gamemode=!spectator,scores={kits.criterion.shift=1..}] as @s[scores={kits.ability1CD=100..},predicate=kits:items/luffy/fist] at @s run function kits:luffy/weapon1shift
...
execute at @s[scores={kits.criterion.shiftOn=2..}] run function kits:luffy/pistol/charging

execute as @s[scores={kits.criterion.shiftOn=40..},tag=LuffyUsingPistol] at @s run function kits:luffy/pistol/shootingpistol
execute as @s[scores={kits.criterion.shiftOff=3..},tag=LuffyUsingPistol] at @s run function kits:luffy/pistol/shootingpistol
execute as @e[type=area_effect_cloud,tag=LuffyPistol] at @s run function kits:luffy/pistol/pistol
...
execute as @s[scores={kits.criterion.COS=1..}] as @s[scores={kits.ability2CD=100..},predicate=kits:items/luffy/fist] at @s run function kits:luffy/weapon1cos

# Gatling
scoreboard players add @s[scores={kits.ability3CD=..199}] kits.ability3CD 1
execute as @s[scores={kits.criterion.COS=1..}] as @s[scores={kits.ability3CD=200..},predicate=kits:items/luffy/skills] at @s run function kits:luffy/weapon2cos
execute as @s[tag=LuffyGatling] at @s run function kits:luffy/gatling

# Grab
scoreboard players add @s[scores={kits.ability4CD=..199}] kits.ability4CD 1
execute as @p[gamemode=!spectator,scores={kits.criterion.shift=1..}] as @s[scores={kits.ability4CD=200..},predicate=kits:items/luffy/skills] at @s run function kits:luffy/weapon2shift
execute as @e[type=area_effect_cloud,tag=LuffyGrab] at @s run function kits:luffy/grab/grabprojectile
