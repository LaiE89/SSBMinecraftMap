execute if score @s kits.timer2 matches 100.. at @s rotated ~ 90 run function kits:luffy/haki/hakiactivate
...
execute if score @s[tag=LuffyGear] kits.timer3 matches 300.. run function kits:luffy/haki/hakideactivate
