...
execute at @s[tag=!KanekiKakuja] positioned ~ ~1.5 ~ run function kits:kaneki/kanekipassive2

scoreboard players set @s[tag=KanekiKakuja] kits.raycastTick 0
execute at @s[tag=KanekiKakuja] positioned ~ ~1.5 ~ run function kits:kaneki/kanekipassive5
