...
tag @s remove Terminator
tag @s remove Trailblazer
tag @s remove Vergil
tag @s remove Zed

# kit tags
tag @s remove 2BEvasion
tag @s remove 2BinGravity
tag @s remove AbianBlackHoleHit
...
tag @s remove ChosenUndeadStampSlashed
tag @s remove ChosenUndeadSunlightSpear
tag @s remove ChosenUndeadTired
tag @s remove ChosenUndeadTranquilWalk
tag @s remove CynthiaJustSwitched
...
tag @s remove DragonbornForceDamage
tag @s remove DragonbornMarked
tag @s remove EdwardBreak
tag @s remove EdwardCaged
tag @s remove EdwardCastingWall
tag @s remove EkkoDiving
tag @s remove EkkoPassiveCD
tag @s remove EkkoTimeWinderHit
tag @s remove EkkoTimeWinderHit2
tag @s remove Garchomp
tag @s remove GarchompDance
tag @s remove GarchompDragonRush
tag @s remove GarchompEarthquake
...
tag @s remove JacketBatSwingCollided
tag @s remove JacketBatSwingKB
tag @s remove JacketPulverizeStrike
tag @s remove JacketPulverizeStrike2
tag @s remove JacketPulverizeStrike3
tag @s remove JacketShotgunKB
tag @s remove JacketStun
...
tag @s remove KiritoBlitz
tag @s remove KiritoBlitzTarget
tag @s remove KiritoHorizontalSquare
tag @s remove KiritoStabbed
...
tag @s remove KiryuTigerDrop
tag @s remove KratosHookDmg
tag @s remove KratosPull
tag @s remove KratosRage
tag @s remove KratosSlashed
tag @s remove Lucario
tag @s remove LucarioAuraSphere
tag @s remove LucarioBulletPunched
tag @s remove LucarioBulletPunched2
...
tag @s remove LuffyGear
tag @s remove LuffyGrabbed
tag @s remove LuffyKB
tag @s remove LuffyPistolDestination
tag @s remove LuffyUsingPistol
tag @s remove Midoriya100DashCollided
tag @s remove Midoriya100Dashing
tag @s remove Midoriya100DelawareSmashKB
tag @s remove Midoriya100DetroitSmashKB
tag @s remove MidoriyaCharging
...
tag @s remove NessKnockback
tag @s remove NessPKFlash
tag @s remove NessPKRocket
tag @s remove NoctisGreatsword
tag @s remove NoctisThrow
tag @s remove PyramidHeadKB
tag @s remove RaidenAirCrescent
tag @s remove RaidenBladeMode
tag @s remove RaidenCrescentSliced
tag @s remove RaidenHooked
tag @s remove Roserade
tag @s remove RoseradeSeeded
...
tag @s remove SansBlueBonesDamaged
tag @s remove SansDodged
tag @s remove SansInTelekinesis
tag @s remove SansStationary
tag @s remove SansTelekinesis
tag @s remove SirisDarkfire
tag @s remove LaiethDrainingShield
tag @s remove LaiethGettingRitualed
tag @s remove LaiethMirrorForce
tag @s remove LaiethPossessed
tag @s remove LaiethPossessing
tag @s remove LaiethWaboku
...
tag @s remove TerminatorDashCollided
tag @s remove TerminatorDashing
tag @s remove TerminatorLineChargeGrenadeHit
tag @s remove TrailblazerBladeAnimation
tag @s remove TrailblazerJingliuAnimation
tag @s remove TrailblazerLuochaAnimation
...
tag @s remove VergilJudgementCutEnd
...
# kit scoreboards
scoreboard players reset @s kit.id
scoreboard players reset %SirisMagicChanges
scoreboard players reset %SirisMagicData
scoreboard players reset %SirisMagicDataTemp
scoreboard players reset %TrailblazerKB
scoreboard players reset %AbianVFXDelay
scoreboard players reset %AbianUsedMovesArr1
scoreboard players reset %AbianUsedMovesArr2
scoreboard players reset @s kits.specific.abianComboStun
scoreboard players reset @s kits.specific.abianMarked
scoreboard players reset @s kits.specific.abiankits.raycastTick
scoreboard players reset @s kits.specific.dariusBleedTime
scoreboard players reset @s kits.specific.dariusPassive
scoreboard players reset @s kits.specific.ekkoPassiveTick
scoreboard players reset @s kits.specific.ekkoResonance
scoreboard players reset @s kits.specific.gojokits.raycastTick
scoreboard players reset @s kits.specific.ireliaMarkTick
scoreboard players reset @s kits.specific.itadorikits.raycastTick
scoreboard players reset @s kits.specific.jacketStunTick
scoreboard players reset @s kits.specific.noctisBleed
scoreboard players reset @s kits.specific.noctisBleed2
scoreboard players reset @s kits.specific.raidenCrescentTick
...
scoreboard players reset @s kits.ability1CD
scoreboard players reset @s kits.ability2CD
scoreboard players reset @s kits.ability3CD
scoreboard players reset @s kits.ability4CD
scoreboard players reset @s kits.ability5CD

scoreboard players reset @s kits.criterion.shiftOn
scoreboard players reset @s kits.criterion.shiftOff
scoreboard players reset @s kits.criterion.COSon
scoreboard players reset @s kits.criterion.COSoff

scoreboard players reset @s kits.raycastTick
scoreboard players reset @s kits.raycastTick2
scoreboard players reset @s kits.raycastTick3
scoreboard players reset @s kits.raycastTick4

scoreboard players reset @s kits.direction
function kits:_main/inputs/wasd/reset