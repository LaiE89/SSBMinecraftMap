...
# Dash Raycast
execute at @s run function kits:doomslayer/dash/dashdirection
#execute at @s[scores={kits.criterion.run=0}] rotated ~ 0 positioned ~ ~ ~ run function kits:doomslayer/dash/passive3
