...
execute as @e[distance=..5,type=!#kits:non_entity,tag=!Invincible,tag=!Doomslayer,tag=!InLabyrinth] at @s run function kits:doomslayer/frag_grenade/passive4
particle explosion ~ ~0.5 ~ 0 0 0 0 1 force
particle flash ~ ~0.5 ~ 0 0 0 0 5 force
