# example call: function kits:doomslayer/expanding_sphere/play {"Inaccuracy":"100","Speed":"200","Limit":"5","R":"100","G":"100","B":"100","Size":"50"}
## Plays Expanding Sphere
# summon
function kits:doomslayer/expanding_sphere/end
