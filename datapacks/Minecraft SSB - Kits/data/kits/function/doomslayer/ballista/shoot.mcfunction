...
execute if score @s kits.raycastTick matches 2222.. positioned ^ ^ ^ run function kits:doomslayer/ballista/hit

# Energy bolt travels 0.5 blocks repeatedly until collision
execute as @s[scores={kits.raycastTick=..25}] if block ~ ~ ~ #kits:passable positioned ^ ^ ^0.5 run function kits:doomslayer/ballista/shoot
