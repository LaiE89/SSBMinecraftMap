...
function kits:doomslayer/expanding_sphere/play {"Inaccuracy":"150","Speed":"50","Limit":"5","R":"99","G":"27","B":"02","Size":"50"}

## Damage
execute as @e[distance=..4,type=!#kits:non_entity,tag=!Doomslayer,tag=!Invincible,tag=!InLabyrinth] at @s run function kits:doomslayer/ballista/damage