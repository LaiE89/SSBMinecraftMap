## Runs Crescent Slash
# draw parabola
function kits:doomslayer/slash_crescent/parabola
execute positioned as @s run function kits:doomslayer/slash_crescent/draw with storage minecraft:vfx SlashCrescent
...
execute if score %vfxSlashCrescent.thickness kits.dz matches 1.. if score %vfxSlashCrescent.runItt kits.dz > %vfxSlashCrescent.accuracy kits.constant run function kits:doomslayer/slash_crescent/thickness
execute unless score %vfxSlashCrescent.runItt kits.dz > %vfxSlashCrescent.accuracy kits.constant run function kits:doomslayer/slash_crescent/run