...
# values with x,y,z
function kits:doomslayer/slash_crescent/calc_init {"objective":"kits.x"}
function kits:doomslayer/slash_crescent/calc_init {"objective":"kits.y"}
function kits:doomslayer/slash_crescent/calc_init {"objective":"kits.z"}
...
## Run
function kits:doomslayer/slash_crescent/run