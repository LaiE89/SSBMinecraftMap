# example call: function kits:doomslayer/slash_crescent/play {"concavity":"400","thickness":"5","accuracy":"50","yaw":"90","pitch":"0","distance":"5","particle":"flame"}
...
execute as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=VFX_DoomslayerSlashCrescent] at @s run function kits:doomslayer/slash_crescent/get with storage minecraft:vfx SlashCrescent
function kits:doomslayer/slash_crescent/end