...
execute as @s[scores={kits.raycastTick2=2222..}] positioned ^ ^ ^ run execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Mob,tag=!InLabyrinth] at @s run function kits:mob/mobliftdamage
...
execute as @s[scores={kits.raycastTick2=..1111}] positioned ^ ^ ^0.5 run function kits:mob/mobpassive3
