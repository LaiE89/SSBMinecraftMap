...
execute as @s[scores={kits.raycastTick=2222..}] positioned ^ ^ ^ run particle flash ~ ~ ~ 0 0 0 0 20 force
execute as @s[scores={kits.raycastTick=..1111}] positioned ^ ^ ^0.5 run function kits:mob/mobpassive2
