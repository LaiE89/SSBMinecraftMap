...
execute if score @s kits.ability1CD matches 1.. if entity @s[tag=!VergilCharge,tag=!VergilJudgementCut,tag=!VergilJudgementCutEnd,predicate=kits:items/vergil/yamato,gamemode=!spectator,scores={kits.criterion.shift=1..}] run function kits:vergil/judgement_cut/charge
...
execute if score @s kits.ability1CD matches 1.. if score @s kits.criterion.shiftOn matches 100.. if entity @s[tag=VergilCharge,gamemode=!spectator] at @s run function kits:vergil/weapon1shift
execute if score @s kits.ability1CD matches 1.. if entity @s[scores={kits.criterion.shiftOff=2..},tag=VergilCharge,gamemode=!spectator] at @s run function kits:vergil/weapon1shift
...
execute if score @s kits.criterion.shiftOn matches 60 at @s run particle flash ~ ~ ~ 0 0 0 0 1 force
...
execute as @s[tag=VergilJudgementCutEnd] at @s run function kits:vergil/judgement_cut_end/judgementcutendmain
execute as @s[tag=VergilJudgementCut] at @s run function kits:vergil/judgement_cut/judgementcutmain
...
execute as @s[tag=!VergilJudgementCutEnd,tag=!VergilJudgementCut,tag=!VergilCharge,scores={kits.ability2CD=100..}] as @s[scores={kits.criterion.COS=1..},predicate=kits:items/vergil/yamato] at @s run function kits:vergil/weapon1cos
execute as @e[type=area_effect_cloud,tag=summonedswords] at @s run function kits:vergil/summonedsword
...
execute as @s[tag=!VergilJudgementCutEnd,tag=!VergilJudgementCut,tag=!VergilCharge,scores={kits.ability3CD=300..}] as @s[scores={kits.criterion.COS=1..},predicate=kits:items/vergil/forceedge] at @s run function kits:vergil/weapon2cos
execute as @e[type=armor_stand,tag=forceedge] at @s run function kits:vergil/forceedge

# Devil Trigger
scoreboard players add @s[scores={kits.ability4CD=..499}] kits.ability4CD 1
execute as @s[tag=!VergilJudgementCutEnd,tag=!VergilJudgementCut,tag=!VergilCharge,scores={kits.ability4CD=500..}] as @s[scores={kits.criterion.shift=1..},predicate=kits:items/vergil/forceedge,gamemode=!spectator] at @s run function kits:vergil/weapon2shift
execute as @e[type=minecraft:area_effect_cloud,tag=VergilSpiralSwords] at @s run function kits:vergil/spiralswords
execute as @s[tag=VergilDevilTrigger] run function kits:vergil/deviltrigger

# Trick
scoreboard players add @s[tag=VergilInvis] kits.timer3 1
execute as @s[tag=VergilInvis,scores={kits.timer3=20..}] at @s run function kits:vergil/trickdone

execute as @s[tag=VergilDash] at @s run function kits:vergil/trick
