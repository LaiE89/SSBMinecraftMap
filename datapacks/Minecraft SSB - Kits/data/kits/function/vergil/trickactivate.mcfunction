...
execute positioned as @e[limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Vergil,tag=!InLabyrinth] rotated ~ 0 run function kits:vergil/vergilpassive4
