...
execute as @e[type=minecraft:area_effect_cloud,tag=judgementcutendvisual] at @s run function kits:vergil/judgement_cut_end/visual/judgementcutendfinishparticles
