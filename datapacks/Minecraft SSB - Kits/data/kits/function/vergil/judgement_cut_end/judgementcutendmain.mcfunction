...
execute at @s[scores={kits.timer=3}] rotated ~ 0 run function kits:vergil/judgement_cut_end/judgementcut

execute at @s[scores={kits.timer=6}] rotated ~ 0 run function kits:vergil/judgement_cut_end/judgementcut2

execute as @e[type=area_effect_cloud,tag=judgementcutmiddle] at @s run function kits:vergil/judgement_cut_end/visual/judgementcutend

effect clear @s[scores={kits.timer=60..}] resistance
attribute @s[scores={kits.timer=60..}] minecraft:movement_speed modifier remove minecraft:speed.judgementcut.vergil
attribute @s[scores={kits.timer=60..}] minecraft:attack_damage modifier remove minecraft:damage.judgementcut.vergil
