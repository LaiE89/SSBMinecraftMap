...
execute if entity @s[scores={kits.z=-290..290}] run function kits:vergil/judgement_cut/visual/end
execute unless entity @s[scores={kits.z=-290..290}] at @s run function kits:vergil/judgement_cut/visual/cut