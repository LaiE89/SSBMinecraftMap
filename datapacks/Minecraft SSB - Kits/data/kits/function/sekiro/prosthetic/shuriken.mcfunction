...
summon area_effect_cloud ~ ~1 ~ {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:15,Tags:["SekiroShuriken","projectile"]}
...
function kits:sekiro/spiritemblems/cost {Emblems:1}
