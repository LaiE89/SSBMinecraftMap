damage @s 2 bypass:player_attack_no_kb by @e[type=minecraft:area_effect_cloud,tag=SekiroShuriken,limit=1,sort=nearest] from @p[tag=Sekiro]
function kits:sekiro/posture/posturegain {Posture:2}
