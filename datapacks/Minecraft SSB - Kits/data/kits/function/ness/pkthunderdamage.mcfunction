...
particle instant_effect ~ ~1 ~ 0.4 0.5 0.4 0 50 force
...
item replace entity @p[tag=NessInThunder] armor.chest with leather_chestplate[custom_name={"color":"gold","italic":false,"text":"Ness\ Shirt"}',unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"armor.chest.ness",type:"armor",amount:10,operation:"add_value",slot:"chest"}],dyed_color=16701501] 1
item replace entity @p[tag=NessInThunder] armor.legs with leather_leggings[custom_name={"color":"gold","italic":false,"text":"Ness\ Pants"}',unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"tough.legs.ness",type:"armor_toughness",amount:4,operation:"add_value",slot:"legs"}],dyed_color=3949738] 1
item replace entity @p[tag=NessInThunder] armor.feet with leather_boots[custom_name={"color":"gold","italic":false,"text":"Ness\ Shoes"}',unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"speed.feet.ness",type:"movement_speed",amount:0.02,operation:"add_value",slot:"feet"}],dyed_color=11546150] 1
