...
execute if entity @s[scores={kits.timer=..10}] run execute as @e[distance=..2,type=!#kits:non_entity,tag=!Invincible,tag=!Ness,tag=!InLabyrinth] at @s run function kits:ness/yoyodamage
...
execute if entity @s[scores={kits.timer=11..}] if entity @p[tag=Ness,distance=..1.5] run function kits:ness/yoyoretrieve
