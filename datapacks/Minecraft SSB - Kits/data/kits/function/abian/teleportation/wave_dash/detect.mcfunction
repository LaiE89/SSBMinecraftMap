...
execute if entity @e[type=!#kits:non_entity,distance=..2,tag=!Abian,tag=!InLabyrinth,tag=!Invincible] run function kits:abian/teleportation/wave_dash/found

# Ray travels 0.5 blocks repeatedly until it meets conditions
execute if score @s kits.specific.abiankits.raycastTick matches ..29 positioned ^ ^ ^0.5 run function kits:abian/teleportation/wave_dash/detect
