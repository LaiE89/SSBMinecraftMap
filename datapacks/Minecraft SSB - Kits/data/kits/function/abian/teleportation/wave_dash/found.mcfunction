...
# FX
execute positioned as @s rotated ~ 90 positioned ~ ~0.5 ~ run function kits:abian/vfx/particles/ripple/type1
execute positioned as @s rotated ~180 0 positioned ~ ~-0.1 ~ run function kits:abian/vfx/particles/afterimages/run
...
execute positioned as @e[type=!#kits:non_entity,distance=..2,limit=1,sort=nearest,tag=!Abian,tag=!InLabyrinth,tag=!Invincible] run function kits:abian/teleportation/wave_dash/teleport
