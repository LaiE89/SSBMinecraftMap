...
execute if score @s kits.specific.abiankits.raycastTick matches 2222.. run function kits:abian/teleportation/fast_fall/found

# Ray travels 0.5 blocks repeatedly until it meets conditions
execute if score @s kits.specific.abiankits.raycastTick matches ..29 positioned ~ ~-0.5 ~ run function kits:abian/teleportation/fast_fall/detect
