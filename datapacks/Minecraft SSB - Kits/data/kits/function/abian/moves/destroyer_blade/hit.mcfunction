...
execute rotated as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=AbianDestroyerBlade] run function kits:abian/moves/destroyer_blade/kb

# Combo meter
execute as @p[tag=Abian] at @s run function kits:abian/combo_meter/charge/weak
execute if score @s kits.specific.abianMarked matches 1.. as @p[tag=Abian] at @s run function kits:abian/combo_meter/charge/weak
