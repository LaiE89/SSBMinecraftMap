...
execute positioned ~ ~1.5 ~ run function kits:abian/moves/starstorm/calculate_range

# FX
execute rotated ~ 0 positioned ^0.0625 ^2.4375 ^ run function kits:abian/vfx/particles/star
