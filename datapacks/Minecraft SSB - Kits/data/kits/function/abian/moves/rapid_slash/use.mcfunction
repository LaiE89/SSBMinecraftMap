...
summon area_effect_cloud ~ ~ ~ {Particle:{type:"block",block_state:"minecraft:air"},Radius:0f,WaitTime:0,Duration:60,Tags:["AbianRslashTravelMarker","AbianRslashYRotUp"]}
...
execute rotated ~ 0 positioned ~ ~ ~ run function kits:abian/moves/rapid_slash/calculate_range
...
schedule function kits:abian/inputs/reset/global/delay 3s replace
