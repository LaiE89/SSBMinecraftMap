...
# Collision
execute rotated ~ 0 positioned ^ ^ ^2 as @e[type=!#kits:non_entity,distance=..4,tag=!Abian,tag=!InLabyrinth,tag=!Invincible] at @s run function kits:abian/moves/death_mark/hit

# FX
execute rotated ~ 0 positioned ^-0.15625 ^1 ^ run function kits:abian/vfx/particles/slash/type5
