...
execute as @e[type=!#kits:non_entity,distance=..2.5,tag=!Abian,tag=!AbianLabyrinthShopHit,tag=!InLabyrinth,tag=!Invincible] at @s run function kits:abian/moves/labyrinth_shop/hit
...
execute if score @s kits.raycastTick matches ..29 positioned ^ ^ ^0.5 run function kits:abian/moves/labyrinth_shop/dashing
