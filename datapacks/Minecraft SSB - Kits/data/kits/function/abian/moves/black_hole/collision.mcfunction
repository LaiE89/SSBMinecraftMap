...
# Hits nearby enemies
execute as @e[type=!#kits:non_entity,distance=..2,limit=1,sort=nearest,tag=!Abian,tag=!AbianBlackHoleHit,tag=!InLabyrinth,tag=!Invincible] at @s run function kits:abian/moves/black_hole/hit
