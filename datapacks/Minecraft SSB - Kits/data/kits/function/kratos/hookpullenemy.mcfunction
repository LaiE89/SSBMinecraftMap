...
execute at @s[scores={kits.timer2=10..}] facing entity @p[tag=Kratos] feet run tp @s ^ ^ ^1.25
execute at @s[scores={kits.timer2=10..}] positioned ~ ~1 ~ if entity @p[tag=Kratos,distance=..3] run function kits:kratos/hookend
