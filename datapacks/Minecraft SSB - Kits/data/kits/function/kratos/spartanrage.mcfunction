...
execute if score @s kits.timer4 matches 5.. run scoreboard players remove @s kits.timer3 1
scoreboard players reset @s[scores={kits.timer4=5..}] kits.timer4
...
execute if score @s kits.timer3 matches ..0 run function kits:kratos/spartanrageend
