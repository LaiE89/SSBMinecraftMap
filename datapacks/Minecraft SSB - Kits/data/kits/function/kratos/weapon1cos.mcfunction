schedule clear kits:kratos/slashend

execute if entity @s[tag=KratosRage] run function kits:kratos/spartanrageend
...
execute at @s rotated ~ 0 positioned ~ ~1.5 ~ run function kits:kratos/slashlocation
