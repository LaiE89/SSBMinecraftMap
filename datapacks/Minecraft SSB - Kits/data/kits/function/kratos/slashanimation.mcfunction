execute at @s positioned ~ ~1.75 ~ facing entity @p[tag=Kratos] eyes positioned ~ ~-0.5 ~ run function kits:kratos/slashchain
particle flame ~ ~1 ~ 0 0 0 0 1 force
#execute as @e[distance=..2,type=!#kits:non_entity,tag=!Invincible,tag=!Kratos,tag=!InLabyrinth,tag=!KratosSlashed] at @s run function kits:kratos/slashdamage
...
execute if entity @e[type=minecraft:area_effect_cloud,tag=kratosslashplace,distance=..2] run schedule function kits:kratos/slashend 8t replace
...
execute unless entity @e[type=minecraft:area_effect_cloud,tag=kratosslashplace] run execute at @s facing entity @p[tag=Kratos] feet run function kits:kratos/slashanimationreturn

execute if entity @s[tag=kratosleft,tag=!kratosslash2,tag=!kratosslash4] unless entity @e[type=minecraft:area_effect_cloud,tag=kratosslashplace] if entity @p[tag=Kratos,distance=..2.75] run function kits:kratos/slashend
execute if entity @s[tag=kratosleft,tag=kratosslash2] unless entity @e[type=minecraft:area_effect_cloud,tag=kratosslashplace] if entity @p[tag=Kratos,distance=..4.5] run function kits:kratos/slashend
execute if entity @s[tag=kratosleft,tag=kratosslash4] unless entity @e[type=minecraft:area_effect_cloud,tag=kratosslashplace] if entity @p[tag=Kratos,distance=..4] run function kits:kratos/slashend
