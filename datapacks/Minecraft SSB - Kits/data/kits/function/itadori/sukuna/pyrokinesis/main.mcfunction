...
# Damage and movement
execute as @e[distance=..2,tag=!Itadori,tag=!InLabyrinth,tag=!Invincible,type=!#kits:non_entity] at @s run function kits:itadori/sukuna/pyrokinesis/hit
...
execute if score @s kits.timer matches 2.. positioned ^0 ^0.0375 ^-0.0375 run function kits:itadori/vfx/particles/arrow
