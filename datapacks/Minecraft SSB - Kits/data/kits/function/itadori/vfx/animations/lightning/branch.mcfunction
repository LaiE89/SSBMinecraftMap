...
execute if score @s kits.raycastTick2 matches 1 if score @s kits.raycastTick3 matches 1.. run function kits:itadori/vfx/animations/lightning/start
...
execute rotated as @s run function kits:itadori/vfx/animations/lightning/new
