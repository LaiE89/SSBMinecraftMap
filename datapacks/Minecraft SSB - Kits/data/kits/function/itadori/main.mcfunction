...
execute if entity @s[scores={kits.criterion.death=1..}] at @s run function kits:itadori/itadori/swap
execute if entity @s[tag=Sukuna] at @s run function kits:itadori/sukuna/boredom
execute if entity @s[tag=!Sukuna,tag=!ItadoriRage,scores={kits.timer=100..}] at @s run function kits:itadori/itadori/rage
execute if entity @s[tag=!Sukuna,predicate=kits:items/itadori/itadori,gamemode=!spectator] at @s run function kits:itadori/itadori/use
execute if entity @s[tag=Sukuna,predicate=kits:items/itadori/itadori,gamemode=!spectator] at @s run function kits:itadori/sukuna/use

# Assigns Tasks to Entities
execute as @e[type=area_effect_cloud] at @s run function kits:itadori/assign_tasks/to_aecs
execute if entity @s[tag=ItadoriBlackflash] at @s run function kits:itadori/itadori/black_flash/main
execute if score @s[scores={kits.ability1CD=..99}] kits.timer2 matches 4.. at @s run function kits:itadori/energyregen
