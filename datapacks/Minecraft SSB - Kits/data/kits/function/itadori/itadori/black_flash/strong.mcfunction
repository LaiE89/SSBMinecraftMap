...
# Effects
execute as @e[distance=..6,limit=1,sort=nearest,nbt={HurtTime:10s},tag=!Itadori,tag=!InLabyrinth,tag=!Invincible,type=!#kits:non_entity] at @s run function kits:itadori/itadori/black_flash/hit
