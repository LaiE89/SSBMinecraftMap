...
# FX
execute rotated ~ 90 positioned ~ ~1 ~ run function kits:itadori/vfx/particles/aura
execute rotated ~180 0 positioned ~ ~-0.4 ~ run function kits:itadori/vfx/particles/aura2
