...
execute as @s[scores={kits.raycastTick=2222}] positioned ^ ^ ^ run execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Cynthia,tag=!InLabyrinth] at @s run function kits:cynthia/roserade/stunsporeeffects
...
execute as @s[scores={kits.raycastTick=..14}] positioned ^ ^ ^0.5 run function kits:cynthia/roserade/stunsporelocation
