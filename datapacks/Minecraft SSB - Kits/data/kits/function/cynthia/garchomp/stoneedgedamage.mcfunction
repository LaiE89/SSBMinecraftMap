...
execute as @e[distance=..3,type=!#kits:non_entity,tag=!Invincible,tag=!Cynthia,tag=!InLabyrinth] at @s run function kits:cynthia/garchomp/knockup
schedule function kits:cynthia/garchomp/stoneedgefinish 10t append
