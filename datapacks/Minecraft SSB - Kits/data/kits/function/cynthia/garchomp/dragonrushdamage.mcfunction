...
damage @s 9 bypass:player_attack by @p[tag=Cynthia]
tag @s add GarchompRushKB
execute as @p[tag=Cynthia] at @s run scoreboard players set @s kits.raycastTick 0
execute as @p[tag=Cynthia] at @s rotated ~ 0 run function kits:cynthia/garchomp/dragonrushkb
tag @s remove GarchompRushKB
execute as @p[tag=Cynthia] at @s run function kits:cynthia/garchomp/dragonrushend
