...
# values with x,y,z
function kits:kirito/slash_crescent/calc_init {"objective":"kits.x"}
function kits:kirito/slash_crescent/calc_init {"objective":"kits.y"}
function kits:kirito/slash_crescent/calc_init {"objective":"kits.z"}
...
## Run
function kits:kirito/slash_crescent/run