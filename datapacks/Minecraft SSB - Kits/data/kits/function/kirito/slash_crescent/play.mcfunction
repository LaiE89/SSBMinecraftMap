# example call: function kits:kirito/slash_crescent/play {"concavity":"400","thickness":"5","accuracy":"50","yaw":"90","pitch":"0","distance":"5","particle":"flame"}
...
execute as @e[type=area_effect_cloud,limit=1,sort=nearest,tag=VFX_KiritoSlashCrescent] at @s run function kits:kirito/slash_crescent/get with storage minecraft:vfx SlashCrescent
function kits:kirito/slash_crescent/end