...
execute if entity @s[scores={kits.timer=3..}] run schedule function kits:kirito/secondattack 8t append
...
execute if entity @s[tag=KiritoHorizontalSquare] if score @s kits.timer2 matches 4.. at @s run function kits:kirito/horizontalsquareactivate
