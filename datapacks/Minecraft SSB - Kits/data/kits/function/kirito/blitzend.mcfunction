...
item replace entity @p[tag=Kirito] armor.feet with leather_boots[custom_name={"italic":false,"text":"The Real Black Swordsman\'s Boots"},unbreakable={},custom_data={KitItem:1b},attribute_modifiers=[{id:"speed.feet.kirito",type:"movement_speed",amount:0.06,operation:"add_value",slot:"feet"}],dyed_color=0] 1
...
execute if entity @e[tag=KiritoBlitzTarget] as @e[tag=KiritoBlitzTarget,limit=1,sort=nearest] at @s run function kits:kirito/blitzendlocation
