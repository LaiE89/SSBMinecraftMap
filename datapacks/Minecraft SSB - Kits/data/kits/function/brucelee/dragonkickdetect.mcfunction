...
execute as @s[scores={kits.raycastTick3=2222..}] positioned ^ ^ ^ run execute as @e[distance=..2,limit=1,sort=nearest,type=!#kits:non_entity,tag=!Invincible,tag=!Brucelee,tag=!InLabyrinth] at @s run function kits:brucelee/dragonkickknockback
execute as @s[scores={kits.raycastTick3=2222..}] positioned ^ ^ ^ run scoreboard players set @s kits.ability5CD 0
execute as @s[scores={kits.raycastTick3=..8}] positioned ^ ^ ^0.5 run function kits:brucelee/dragonkickdetect
