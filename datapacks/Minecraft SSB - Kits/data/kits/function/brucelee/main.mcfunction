...
execute as @s[scores={kits.ability1CD=100},predicate=kits:items/brucelee/nunchucks] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:brucelee/weapon1cos

execute as @e[type=area_effect_cloud,tag=WATA] at @s run function kits:brucelee/wata
...
execute if entity @e[tag=BruceMarked] as @s[gamemode=!spectator,tag=Brucelee,scores={kits.ability1CD=10..}] as @s[scores={kits.criterion.COS=1..},tag=!BruceFlyingKick,predicate=kits:items/brucelee/nunchucks] at @s run function kits:brucelee/flyingkick
...
execute as @e[tag=BruceMarked] at @s if entity @p[tag=Brucelee,tag=BruceFlyingKick,distance=..3] run function kits:brucelee/flyingkickdamage

# Persistence
scoreboard players add @s[scores={kits.ability2CD=..149}] kits.ability2CD 1
execute as @s[scores={kits.ability2CD=150..},predicate=kits:items/brucelee/persistence] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:brucelee/weapon2cos
...
execute as @s[gamemode=!spectator,scores={kits.ability3CD=300..},predicate=kits:items/brucelee/persistence] as @s[scores={kits.criterion.shift=1..}] at @s run function kits:brucelee/weapon2shift
...
execute as @s[gamemode=!spectator,scores={kits.ability4CD=100..},predicate=kits:items/brucelee/nunchucks] as @s[scores={kits.criterion.shift=1..}] at @s run function kits:brucelee/weapon1shift

# Dragon Kick
scoreboard players add @s[scores={kits.ability5CD=..299}] kits.ability5CD 1
execute as @s[scores={kits.ability5CD=300..},predicate=kits:items/brucelee/dragon_kick] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:brucelee/weapon3cos
...
execute at @e[tag=BruceDragonKicked] as @e[distance=..2,type=!#kits:non_entity,tag=!Invincible,tag=!Brucelee,tag=!BruceDragonKicked,tag=!InLabyrinth] at @s run function kits:brucelee/dragonkickdamage
execute as @e[tag=BruceDragonKicked] at @s if entity @e[type=minecraft:area_effect_cloud,tag=BruceleeKick,distance=..2] run function kits:brucelee/dragonkickend
