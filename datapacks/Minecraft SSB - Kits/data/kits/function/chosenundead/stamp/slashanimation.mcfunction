...
#execute positioned ~ ~-1 ~ run tp @p[tag=ChosenUndead] ~ ~ ~
execute positioned ^ ^ ^1 run function kits:chosenundead/stamp/claymoreparticles
execute positioned ^ ^ ^3 as @e[distance=..4,type=!#kits:non_entity,tag=!Invincible,tag=!ChosenUndead,tag=!InLabyrinth,tag=!ChosenUndeadStampSlashed] at @s run function kits:chosenundead/stamp/slashdamage
