...
# Stamina
tag @s[tag=ChosenUndeadTired,scores={kits.timer=100..}] remove ChosenUndeadTired
...
# wasd detection
execute at @s run function kits:_main/inputs/wasd/main

# Roll
scoreboard players add @s[scores={kits.ability1CD=..9}] kits.ability1CD 1
execute as @s[tag=!ChosenUndeadTired,tag=!ChosenUndeadSunlightSpear,scores={kits.ability1CD=10..},predicate=kits:items/chosenundead/claymore] at @s[gamemode=!spectator,scores={kits.criterion.COS=1..}] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] run function kits:chosenundead/roll/roll
execute at @s facing entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll,limit=1,sort=nearest] eyes run function kits:chosenundead/roll/rolling
#execute at @s if entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll,distance=..1.5] run function kits:chosenundead/roll/rollend

# Stamp 
scoreboard players add @s[scores={kits.ability2CD=..9}] kits.ability2CD 1
execute as @s[predicate=kits:items/chosenundead/claymore,gamemode=!spectator,scores={kits.criterion.shift=1..}] at @s[tag=!ChosenUndeadStamp,scores={kits.ability2CD=10..}] if score @s kits.timer4 matches 10.. unless entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] rotated ~ 90 run function kits:chosenundead/stamp/stamp
execute if entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] as @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] at @s run function kits:chosenundead/stamp/slashanimation
execute if entity @e[tag=ChosenUndeadStampSlashed] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] run tag @e[tag=ChosenUndeadStampSlashed] remove ChosenUndeadStampSlashed 

# Estus
execute if score @s kits.criterion.kill matches 1.. at @s run function kits:chosenundead/flask/flaskreplenish
scoreboard players add @s[scores={kits.ability3CD=..9}] kits.ability3CD 1
execute as @s[predicate=kits:items/chosenundead/flask,scores={kits.criterion.shift=1..}] at @s[scores={kits.ability3CD=10..}] run function kits:chosenundead/flask/flaskswitch

# Miracles
scoreboard players add @s[scores={kits.ability4CD=..9}] kits.ability4CD 1
execute as @s[scores={kits.ability4CD=10..},predicate=kits:items/chosenundead/talisman] at @s[gamemode=!spectator,scores={kits.criterion.shift=1..}] run function kits:chosenundead/miracles/switch

scoreboard players add @s[scores={kits.ability5CD=..19}] kits.ability5CD 1

execute as @s[tag=!ChosenUndeadSunlightSpear,tag=!ChosenUndeadStamp,scores={kits.ability5CD=20..},predicate=kits:items/chosenundead/talisman] at @s[scores={kits.criterion.COS=1..}] if score @s kits.timer5 matches 0 if score @s kits.timer4 matches 25.. unless entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] run function kits:chosenundead/miracles/sunlightspear
execute if entity @s[tag=ChosenUndeadSunlightSpear] at @s run function kits:chosenundead/miracles/sunlightspearanimation
execute if entity @e[type=area_effect_cloud,tag=ChosenUndeadSpear,tag=!ChosenUndeadSpearCharge] as @e[type=area_effect_cloud,tag=ChosenUndeadSpear,tag=!ChosenUndeadSpearCharge] at @s run function kits:chosenundead/miracles/sunlightspearthrown

execute as @s[tag=!ChosenUndeadSunlightSpear,tag=!ChosenUndeadStamp,scores={kits.ability5CD=20..},predicate=kits:items/chosenundead/talisman] at @s[scores={kits.criterion.COS=1..}] if score @s kits.timer5 matches 1 if score @s kits.timer4 matches 50.. unless entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] run function kits:chosenundead/miracles/wrathofthegods
execute if entity @e[type=area_effect_cloud,tag=ChosenUndeadWrathOfTheGods] as @e[type=area_effect_cloud,tag=ChosenUndeadWrathOfTheGods] at @s run function kits:chosenundead/miracles/wrath_of_the_gods/run

execute as @s[tag=!ChosenUndeadSunlightSpear,tag=!ChosenUndeadStamp,scores={kits.ability5CD=20..},predicate=kits:items/chosenundead/talisman] at @s[scores={kits.criterion.COS=1..}] if score @s kits.timer5 matches 2 if score @s kits.timer4 matches 75.. unless entity @e[type=minecraft:area_effect_cloud,tag=DarkSoulsRoll] unless entity @e[type=area_effect_cloud,tag=ChosenUndeadStampSlash] run function kits:chosenundead/miracles/walkofpeace
execute if entity @s[tag=ChosenUndeadTranquilWalk] at @s run function kits:chosenundead/miracles/walkofpeaceeffect
