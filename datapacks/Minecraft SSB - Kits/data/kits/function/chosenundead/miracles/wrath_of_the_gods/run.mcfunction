...
# draw
tp @s ~ ~ ~ 0 -90
execute if score %VFXExpandingSphereIterations kits.z < %VFXExpandingSphereLimit kits.constant at @s run function kits:chosenundead/miracles/wrath_of_the_gods/draw_sphere with storage minecraft:vfx ExpandingSphere
execute if score %VFXExpandingSphereIterations kits.z >= %VFXExpandingSphereLimit kits.constant run function kits:chosenundead/miracles/wrath_of_the_gods/end