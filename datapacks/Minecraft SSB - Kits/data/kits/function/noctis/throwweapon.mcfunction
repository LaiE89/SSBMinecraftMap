execute at @s facing entity @e[type=minecraft:area_effect_cloud,tag=noctisthrowplace,limit=1,sort=nearest] feet run function kits:noctis/projectile/move
...
execute at @s if entity @e[type=minecraft:area_effect_cloud,tag=noctisthrowplace,distance=..3] run function kits:noctis/throwlanded
