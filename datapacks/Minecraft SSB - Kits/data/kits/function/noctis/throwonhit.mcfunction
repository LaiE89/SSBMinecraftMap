...
execute at @s run data modify entity @e[type=armor_stand,tag=NoctisThrownWeapon,sort=nearest,limit=1] Rotation[0] set from entity @s Rotation[0]
execute at @s run data modify entity @e[type=armor_stand,tag=NoctisThrownWeapon,sort=nearest,limit=1] Rotation[1] set from entity @s Rotation[1]
...
schedule function kits:noctis/throw 1t replace
#function kits:noctis/throw
