...
execute as @s[scores={kits.ability3CD=200..},predicate=kits:items/jax/unit] as @s[scores={kits.criterion.COS=1..}] at @s run function kits:jax/weapon2cos
...
execute at @s[tag=JaxCounterstrike,scores={kits.timer=40..}] as @e[distance=..8,type=!#kits:non_entity,tag=!Invincible,tag=!Jax,tag=!InLabyrinth] at @s run function kits:jax/counterstrikedamage
execute as @s[tag=JaxCounterstrike,scores={kits.timer=40..}] at @s run function kits:jax/counterstrike
...
execute as @s[scores={kits.ability4CD=500..},predicate=kits:items/jax/unit] as @s[gamemode=!spectator,tag=Jax,scores={kits.criterion.shift=1..}] at @s run function kits:jax/weapon2shift

# Leapstrike
scoreboard players add @s[scores={kits.ability2CD=..99}] kits.ability2CD 1
execute as @s[scores={kits.ability2CD=100..},predicate=kits:items/jax/lamp] as @s[gamemode=!spectator,scores={kits.criterion.shift=1..}] at @s run function kits:jax/weapon1shift

execute at @s run execute if entity @e[tag=JaxLeapstrikeTo] at @s facing entity @e[tag=JaxLeapstrikeTo] eyes run tp @s ^ ^1 ^1.25
execute as @e[tag=JaxLeapstrikeTo] at @s if entity @p[tag=Jax,distance=..4] run execute at @s run function kits:jax/leapstrikedamage

# Empower
scoreboard players add @s[scores={kits.ability1CD=..39}] kits.ability1CD 1
execute as @s[scores={kits.ability1CD=40..},tag=!JaxEmpowered] as @s[scores={kits.criterion.COS=1..},predicate=kits:items/jax/lamp] at @s run function kits:jax/weapon1cos
...
execute at @s[scores={kits.criterion.attack=1..},tag=JaxEmpowered] as @e[limit=1,sort=nearest,nbt={HurtTime:10s},type=!#kits:non_entity,tag=!Invincible,tag=!Jax,tag=!InLabyrinth] at @s run function kits:jax/empowereddamage
...
# Passive
execute at @s[scores={kits.timer3=3..}] as @e[limit=1,sort=nearest,nbt={HurtTime:10s},type=!#kits:non_entity,tag=!Invincible,tag=!Jax,tag=!InLabyrinth] at @s run function kits:jax/3hitpassive
