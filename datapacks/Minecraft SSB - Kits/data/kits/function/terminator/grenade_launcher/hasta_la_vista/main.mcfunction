...
# Collision
execute if entity @e[distance=..2,limit=1,sort=nearest,tag=!Terminator,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] run function kits:terminator/grenade_launcher/hasta_la_vista/collision

# Duration until grenade explodes automatically
execute if data entity @s {Age:5} run function kits:terminator/grenade_launcher/hasta_la_vista/collision
