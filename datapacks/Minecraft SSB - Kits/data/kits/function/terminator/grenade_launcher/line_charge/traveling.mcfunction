...
# Collision
execute positioned ^ ^0.5 ^-2.25 as @e[distance=..2.25,limit=1,sort=nearest,tag=!Terminator,tag=!TerminatorLineChargeGrenadeHit,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] at @s run function kits:terminator/grenade_launcher/line_charge/hit
