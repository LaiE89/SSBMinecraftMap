...
# Collision
execute if entity @e[distance=..1.5,limit=1,sort=nearest,tag=!Terminator,tag=!InLabyrinth,type=!#kits:non_entity,tag=!Invincible] run function kits:terminator/shotgun/shoot/collision
