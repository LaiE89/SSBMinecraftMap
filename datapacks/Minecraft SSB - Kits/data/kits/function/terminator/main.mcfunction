...
execute if entity @s[predicate=kits:items/terminator/shotgun,gamemode=!spectator] at @s run function kits:terminator/shotgun/use
execute if entity @s[scores={kits.timer=..0}] at @s run function kits:terminator/shotgun/shoot/reloading
execute if entity @s[predicate=kits:items/terminator/grenade_launcher,gamemode=!spectator] at @s run function kits:terminator/grenade_launcher/use

# Assigns Tasks to Entities
execute as @e[type=area_effect_cloud] at @s run function kits:terminator/assign_tasks/to_aecs
execute as @e[type=armor_stand] at @s run function kits:terminator/assign_tasks/to_armorstands
execute if entity @s[tag=TerminatorDashing] at @s run function kits:terminator/shotgun/dash/main
