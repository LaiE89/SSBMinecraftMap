...
execute as @e[type=chest_minecart,tag=ui] if score @s system.ui.id = %search system.ui.id run data remove entity @s Items
execute as @e[tag=ui] if score @s system.ui.id = %search system.ui.id run kill @s
