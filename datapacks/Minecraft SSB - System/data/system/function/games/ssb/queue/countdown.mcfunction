...
title @a[tag=arena.inside] title [{"text":"Starting in ","color":"white"},{"score":{"name":"%arena.queueCountdownSeconds","objective":"system.global"},"color":"green"}]

# sound
playsound block.note_block.pling neutral @a[tag=arena.inside] ~ ~ ~ 1 1 1
