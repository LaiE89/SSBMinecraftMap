...
execute as @p[tag=Zed,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Shadow Weapons","italic":false,"color":"dark_red"}]'}}}}] as @p[tag=Zed,scores={Ability1CD=80..}] at @s run function datapack:zed_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Shadow Weapons","italic":false,"color":"dark_red"}]'}}}}] as @p[tag=Zed,scores={Ability2CD=60..}] at @s run function datapack:zed_functions/weapon1shift
...
execute as @p[tag=Zed,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Living Shadow","italic":false,"color":"dark_red"}]'}}}}] as @p[tag=Zed,scores={Ability3CD=300..}] at @s run function datapack:zed_functions/weapon2cos

execute at @p[gamemode=!spectator,tag=!ZedNoSwitch,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Living Shadow","italic":false,"color":"dark_red"}]'}}}}] run summon armor_stand ~ ~1 ~ {Tags:["zedshadow2"],Invisible:1,Invulnerable:1}
tp @e[type=armor_stand,tag=zedshadow2] @p[tag=Zed]
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Living Shadow","italic":false,"color":"dark_red"}]'}}}}] run tp @p[tag=Zed] @e[type=armor_stand,tag=zedshadow,limit=1,sort=nearest]
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Living Shadow","italic":false,"color":"dark_red"}]'}}}}] run tp @e[type=armor_stand,tag=zedshadow,limit=1,sort=nearest] @e[type=armor_stand,tag=zedshadow2,limit=1,sort=nearest]
...
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Living Shadow","italic":false,"color":"dark_red"}]'}}}}] run tag @p[tag=Zed] add ZedNoSwitch

# Death Mark
scoreboard players add @p[tag=Zed,scores={Ability4CD=..499}] Ability4CD 1
execute as @p[tag=Zed,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Death Mark","italic":false,"color":"dark_red"}]'}}}}] at @s as @s[scores={Ability4CD=500..}] run function datapack:zed_functions/weapon2shift
...
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch2,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Death Mark","italic":false,"color":"dark_red"}]'}}}}] run summon armor_stand ~ ~1 ~ {Tags:["ultshadow2"],Invisible:1,Invulnerable:1}
tp @e[type=armor_stand,tag=ultshadow2] @p[tag=Zed]
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch2,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Death Mark","italic":false,"color":"dark_red"}]'}}}}] run tp @p[tag=Zed] @e[type=armor_stand,tag=ultshadow,limit=1,sort=nearest]
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch2,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Death Mark","italic":false,"color":"dark_red"}]'}}}}] run tp @e[type=armor_stand,tag=ultshadow,limit=1,sort=nearest] @e[type=armor_stand,tag=ultshadow2,limit=1,sort=nearest]
...
execute at @p[gamemode=!spectator,tag=!ZedNoSwitch2,tag=Zed,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Death Mark","italic":false,"color":"dark_red"}]'}}}}] run tag @p[tag=Zed] add ZedNoSwitch2
