...
execute as @p[tag=Ekko,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ekko\'s Lightsaber","italic":false,"color":"dark_aqua"}]'}}}}] as @p[tag=Ekko,scores={Basic_COS=1..}] at @s run function datapack:ekko_functions/weapon1cos
...
execute as @e[type=armor_stand,tag=Winder,scores={Timer=..5}] at @s if entity @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ekko,tag=!InLabyrinth] run scoreboard players set @s Timer 6
execute at @e[type=armor_stand,tag=Winder,scores={Timer=..40}] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ekko,tag=!InLabyrinth,tag=!EkkoTimeWinderHit] at @s run function datapack:ekko_functions/winder

execute if entity @e[type=armor_stand,tag=Winder,scores={Timer=41}] run tag @e[tag=EkkoTimeWinderHit] remove EkkoTimeWinderHit

execute at @e[type=armor_stand,tag=Winder,scores={Timer=41..}] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ekko,tag=!InLabyrinth,tag=!EkkoTimeWinderHit2] at @s run function datapack:ekko_functions/winder2
...
execute at @p[tag=Ekko,scores={Basic_Attack=1..}] run scoreboard players add @e[sort=nearest,limit=1,tag=!Ekko,tag=!InLabyrinth,tag=!EkkoPassiveCD,nbt={HurtTime:10s}] EkkoResonance 1
...
execute as @p[gamemode=!spectator,tag=Ekko,scores={Ability2CD=100..}] as @p[scores={Basic_Shift=1},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ekko\'s Lightsaber","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ekko_functions/weapon1shift
...
execute as @p[gamemode=!spectator,tag=EkkoDiving,tag=Ekko,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ekko\'s Lightsaber","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ekko_functions/phasediving
...
execute as @p[tag=Ekko,scores={Ability3CD=300},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ekko\'s Z-Drive","italic":false,"color":"dark_aqua"}]'}}}}] as @p[tag=Ekko,scores={Basic_COS=1..}] at @s run function datapack:ekko_functions/weapon2cos
...
execute at @e[tag=convergence,type=armor_stand,scores={Timer=25..}] run effect give @e[distance=..7,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ekko,tag=!InLabyrinth] minecraft:slowness 1 1 true
...
execute at @p[gamemode=!spectator,tag=Ekko,scores={Ability4CD=500..}] unless entity @e[type=armor_stand,tag=chronobreak] run summon armor_stand ~ ~ ~ {Tags:["chronobreak"],DisabledSlots:2039583,NoGravity:1b,Marker:1b,Invisible:1,Invulnerable:1,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{Unbreakable:1,display:{color:8900331}}},{},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1,display:{color:8900331}}},{id:"minecraft:light_blue_concrete_powder",Damage:3,Count:1b}]}
execute as @p[gamemode=!spectator,tag=Ekko,scores={Ability4CD=500..}] as @p[tag=Ekko,scores={Basic_Shift=1..}] as @p[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Ekko\'s Z-Drive","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:ekko_functions/weapon2shift
