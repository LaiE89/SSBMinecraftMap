...
execute as @p[gamemode=!spectator,tag=Guts,scores={Basic_Shift=1..}] as @p[tag=Guts,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:netherite_sword",tag:{display:{Name:'[{"text":"The Dragonslayer","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:guts_functions/weapon1shift
...
# Berserker Armor
execute as @p[gamemode=!spectator,tag=!GutsBerserker,tag=Guts,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Handcannon","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:guts_functions/weapon2shift 
...
execute as @p[tag=Guts,scores={Basic_COS=1..}] as @p[scores={Ability2CD=100},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Handcannon","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:guts_functions/weapon2cos
