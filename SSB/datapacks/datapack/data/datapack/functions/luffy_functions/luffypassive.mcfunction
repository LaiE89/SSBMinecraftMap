...
execute as @p[tag=Luffy,gamemode=!spectator,scores={Basic_Shift=1..}] as @p[tag=Luffy,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Luffy\'s Fists","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:luffy_functions/weapon1shift

scoreboard players add @p[tag=Luffy,scores={Basic_Shift=0}] Basic_ShiftOff 1
scoreboard players reset @p[tag=Luffy,scores={Basic_ShiftOff=3..}] Shift
scoreboard players reset @p[tag=Luffy,scores={Basic_Shift=1..}] Basic_ShiftOff

scoreboard players add @p[tag=Luffy,scores={Basic_Shift=1..},tag=LuffyUsingPistol] Basic_ShiftOn 1
scoreboard players reset @p[tag=Luffy,scores={Basic_ShiftOff=3..}] Basic_ShiftOn
execute at @p[tag=Luffy,scores={Basic_ShiftOn=1}] run tp @e[tag=ChargingLuffyPistol,type=armor_stand] ^ ^ ^-0.5 facing entity @p[tag=Luffy]
execute at @p[tag=Luffy,scores={Basic_ShiftOn=2..}] run execute as @e[tag=ChargingLuffyPistol,type=armor_stand] at @s run tp @s ^ ^ ^-0.5 facing entity @p[tag=Luffy]

execute as @p[tag=Luffy,scores={Basic_ShiftOn=40..},tag=LuffyUsingPistol] at @s run function datapack:luffy_functions/shootingpistol

execute as @p[tag=Luffy,scores={Basic_ShiftOff=3..},tag=LuffyUsingPistol] at @s run function datapack:luffy_functions/shootingpistol2
...
scoreboard players reset @p[tag=Luffy,scores={Basic_ShiftOn=40..}] Basic_ShiftOn
scoreboard players reset @p[tag=Luffy,scores={Basic_ShiftOff=3..}] Basic_ShiftOff

# Dash
scoreboard players add @p[tag=Luffy,scores={Ability2CD=..99}] Ability2CD 1
execute as @p[tag=Luffy,scores={Basic_COS=1..}] as @p[tag=Luffy,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Luffy\'s Fists","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:luffy_functions/weapon1cos

# Gatling
scoreboard players add @p[tag=Luffy,scores={Ability3CD=..199}] Ability3CD 1
execute as @p[tag=Luffy,scores={Basic_COS=1..}] as @p[tag=Luffy,scores={Ability3CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Luffy\'s Skills","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:luffy_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Luffy,scores={Basic_Shift=1..}] as @p[tag=Luffy,scores={Ability4CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Luffy\'s Skills","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:luffy_functions/weapon2shift
...
execute at @e[type=armor_stand,tag=LuffyGrab] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Luffy,tag=!InLabyrinth,tag=!LuffyGrabbed] at @s run function datapack:luffy_functions/grab
