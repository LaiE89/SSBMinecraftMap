...
execute as @p[gamemode=!spectator,tag=Kiryu,scores={Ability2CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_Shift=1..}] at @s run function datapack:kiryu_functions/fightingstyle
...
# Counter
execute as @p[tag=KiryuBrawler,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_COS=1..}] as @p[tag=Kiryu,scores={Timer2=..9}] at @s run function datapack:kiryu_functions/tigerdrop
...
# Heat Move (Serenity)
execute as @p[tag=Kiryu,tag=KiryuBrawler,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_COS=1..}] as @p[tag=Kiryu,scores={Timer2=10..}] at @s run function datapack:kiryu_functions/serenity
...
# Quickstep
execute as @p[tag=KiryuRush,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_COS=1..}] as @p[tag=Kiryu,scores={Timer2=..9}] at @s run function datapack:kiryu_functions/quickstep

# The Knee
execute as @p[tag=KiryuRush,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_COS=1..}] as @p[tag=Kiryu,scores={Timer2=10..}] at @s run function datapack:kiryu_functions/theknee
...
# Bike Smash
execute as @p[tag=KiryuBeast,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"The Dragon of Dojima","italic":false,"color":"gold"}]'}}}}] as @p[tag=Kiryu,scores={Basic_COS=1..}] at @s run function datapack:kiryu_functions/bikesmash
