...
# Kagune Throw
execute as @p[tag=Kaneki,scores={Ability1CD=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kagune","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Basic_COS=1..}] at @s run function datapack:kaneki_functions/weapon1cos
...
execute if entity @e[type=armor_stand,tag=KanekiKagune] as @p[gamemode=!spectator,tag=Kaneki,scores={Ability4CD=10..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kagune","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Basic_Shift=1..}] at @s run function datapack:kaneki_functions/weapon1shift
...
execute if entity @e[type=armor_stand,tag=KanekiKagune] as @p[gamemode=!spectator,tag=Kaneki,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kaneki\'s Skills","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Basic_COS=1..}] at @s run function datapack:kaneki_functions/weapon2cos

# Kakuja
scoreboard players add @p[tag=Kaneki,scores={Ability3CD=..699}] Ability3CD 1
execute as @p[gamemode=!spectator,tag=Kaneki,scores={Ability3CD=700..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Kaneki\'s Skills","italic":false,"color":"red"}]'}}}}] as @p[tag=Kaneki,scores={Basic_Shift=1..}] at @s run function datapack:kaneki_functions/weapon2shift
