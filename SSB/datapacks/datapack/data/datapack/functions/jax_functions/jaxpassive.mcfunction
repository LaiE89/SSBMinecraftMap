...
execute as @p[tag=Jax,scores={Ability3CD=200..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Absolute Unit","italic":false,"color":"dark_purple"}]'}}}}] as @p[tag=Jax,scores={Basic_COS=1..}] at @s run function datapack:jax_functions/weapon2cos
...
execute as @p[tag=Jax,scores={Ability4CD=400..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Absolute Unit","italic":false,"color":"dark_purple"}]'}}}}] as @p[gamemode=!spectator,tag=Jax,scores={Basic_Shift=1..}] at @s run function datapack:jax_functions/weapon2shift

# Leapstrike
scoreboard players add @p[tag=Jax,scores={Ability2CD=..99}] Ability2CD 1
execute as @p[tag=Jax,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Lamp","italic":false,"color":"gold"}]'}}}}] as @p[tag=Jax,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:jax_functions/weapon1shift
...
execute as @p[tag=Jax,scores={Ability1CD=40..},tag=!JaxEmpowered] as @p[tag=Jax,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Lamp","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:jax_functions/weapon1cos

scoreboard players add @p[tag=Jax,scores={Basic_Attack=1..}] Timer3 1

execute at @p[tag=Jax,tag=JaxEmpowered] run particle minecraft:flame ^-0.4 ^1 ^1 0.1 0.1 0.1 0 5
execute at @p[tag=Jax,scores={Timer3=3..},tag=JaxEmpowered] as @e[limit=1,sort=nearest,nbt={HurtTime:10s},type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Jax,tag=!InLabyrinth] at @s run function datapack:damage2

execute at @p[tag=Jax,scores={Basic_Attack=1..},tag=JaxEmpowered] as @e[limit=1,sort=nearest,nbt={HurtTime:10s},type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Jax,tag=!InLabyrinth] at @s run function datapack:jax_functions/empowereddamage
...
# Passive
execute at @p[tag=Jax,scores={Timer3=3..}] as @e[limit=1,sort=nearest,nbt={HurtTime:10s},type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Jax,tag=!InLabyrinth] at @s run function datapack:jax_functions/3hitpassive
