...
scoreboard players add @p[gamemode=!spectator,tag=Sitoe,scores={Basic_Shift=1..},nbt={SelectedItem:{tag:{SitoeWeapon:1b}}}] Basic_ShiftOn 1
...
# Sword of Sitrouille
scoreboard players add @p[tag=Sitoe,scores={Basic_Attack=1..},nbt={SelectedItem:{id:"minecraft:iron_sword",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Sword of Sitrouille","italic":false,"color":"gold"}]'}}}}] Timer 1
...
execute as @p[tag=Sitoe,tag=!SitoePossessing,scores={Ability1CD=30..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Yugioh Cards","italic":false,"color":"dark_red"}]'}}}}] as @s[scores={Basic_COS=1..}] at @s run function datapack:sitoe_functions/cardthrow
...
execute as @p[tag=Sitoe,scores={Ability2CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{SitoeWeapon:1b,Unbreakable:1,display:{Name:'[{"text":"Possession","italic":false,"color":"dark_green"}]'}}}}] as @s[scores={Basic_COS=1..}] at @s run function datapack:sitoe_functions/possessionuse
...
execute as @p[tag=Sitoe,scores={Ability3CD=300..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,SitoeWeapon:1b,display:{Name:'[{"text":"Teleport","italic":false,"color":"dark_purple"}]'}}}}] at @s run execute at @s[scores={Basic_COS=1..}] run function datapack:sitoe_functions/teleportuse
...
execute as @p[tag=Sitoe,scores={Ability4CD=1500..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,SitoeWeapon:1b,display:{Name:'[{"text":"Ritual","italic":false,"color":"aqua"}]'}}}}] at @s as @s[scores={Basic_COS=1..}] run function datapack:sitoe_functions/ritualuse
