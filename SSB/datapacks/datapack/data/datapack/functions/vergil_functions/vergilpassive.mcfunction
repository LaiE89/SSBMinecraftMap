...
execute as @p[tag=Vergil,scores={Ability1CD=150..}] as @p[tag=Vergil,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Yamato\",\"italic\":false,\"color\":\"white\"}]"}}}}] at @s run function datapack:vergil_functions/weapon1cos
...
execute at @p[tag=VergilJudgementCut,scores={Timer=5}] run summon armor_stand ^-3 ^ ^6 {Tags:["judgementcut"],DisabledSlots:2096896,Glowing:1b,NoGravity:1b,Marker:1b,Invisible:1,Invulnerable:1,NoBasePlate:1,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:6574130}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:1462352}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1463928}}},{id:"minecraft:player_head",Damage:3,Count:1b,tag:{display:{Name:"{\"text\":\"Vergil\"}"},Enchantments:[{id:protection,lvl:2}],SkullOwner:{Id:[I;-1944059747,-4700758,-2128888949,-707270116],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTdiMjgwMzczMjJjMTk3ZjdhMDA4MmY4NzY1N2Y2OWIzNTFhODExNjdmMmVlZThiODlmOTllOGMzMWFkNzcxMSJ9fX0="}]}}}}],HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:36}},{}]}
...
execute at @p[tag=VergilJudgementCut,scores={Timer=11}] run summon armor_stand ^3 ^ ^6 {Tags:["judgementcut"],DisabledSlots:2096896,Glowing:1b,NoGravity:1b,Marker:1b,Invisible:1,Invulnerable:1,NoBasePlate:1,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:6574130}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:1462352}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:1463928}}},{id:"minecraft:player_head",Damage:3,Count:1b,tag:{display:{Name:"{\"text\":\"Vergil\"}"},Enchantments:[{id:protection,lvl:2}],SkullOwner:{Id:[I;-1944059747,-4700758,-2128888949,-707270116],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTdiMjgwMzczMjJjMTk3ZjdhMDA4MmY4NzY1N2Y2OWIzNTFhODExNjdmMmVlZThiODlmOTllOGMzMWFkNzcxMSJ9fX0="}]}}}}],HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:36}},{}]}
...
execute as @p[tag=Vergil,scores={Ability2CD=300..}] as @p[tag=Vergil,scores={Basic_COS=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Force Edge\",\"italic\":false,\"color\":\"gold\"}]"}}}}] at @s run function datapack:vergil_functions/weapon2cos
...
execute as @p[tag=Vergil,scores={Ability3CD=150..},gamemode=!spectator] as @p[tag=Vergil,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Force Edge\",\"italic\":false,\"color\":\"gold\"}]"}}}}] at @s run function datapack:vergil_functions/weapon2shift
...
execute as @p[tag=Vergil,scores={Ability4CD=700..}] as @p[tag=Vergil,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Yamato\",\"italic\":false,\"color\":\"white\"}]"}}}}] at @s run function datapack:vergil_functions/weapon1shift
