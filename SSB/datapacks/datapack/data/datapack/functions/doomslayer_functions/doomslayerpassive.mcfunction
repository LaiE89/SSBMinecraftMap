...
execute at @p[gamemode=!spectator,tag=Doomslayer,scores={Basic_Shift=1..},nbt={SelectedItem:{id:"minecraft:golden_sword",tag:{display:{Name:'[{"text":"Crucible","italic":false,"color":"gold"}]'}}}}] as @e[distance=..8,limit=1,sort=nearest,scores={Health2=..4},type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Doomslayer,tag=!InLabyrinth] at @s run function datapack:doomslayer_functions/glorykill

# Shotgun
scoreboard players add @p[tag=Doomslayer,scores={Ability1CD=..99}] Ability1CD 1
execute as @p[tag=Doomslayer,scores={Basic_COS=1..}] as @p[tag=Doomslayer,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Super Shotgun","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:doomslayer_functions/weapon2cos
...
execute as @p[tag=Doomslayer,scores={Basic_COS=1..}] as @p[tag=Doomslayer,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Super Shotgun","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:doomslayer_functions/weapon2cos2

# Meathook
scoreboard players add @p[tag=Doomslayer,scores={Ability2CD=..159}] Ability2CD 1
execute as @p[gamemode=!spectator,tag=Doomslayer,scores={Basic_Shift=1..}] as @p[tag=Doomslayer,scores={Ability2CD=160..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Super Shotgun","italic":false,"color":"dark_red"}]'}}}}] at @s run function datapack:doomslayer_functions/weapon2shift
...
execute at @e[type=armor_stand,tag=meathook] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Doomslayer,tag=!InLabyrinth] at @s run function datapack:doomslayer_functions/hookdamage
...
execute as @p[tag=Doomslayer,scores={Basic_COS=1..}] as @p[tag=Doomslayer,scores={Ability3CD=800..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"BFG 9000","italic":false,"color":"dark_green"}]'}}}}] at @s run function datapack:doomslayer_functions/weapon3cos
