...
# Blood passive
execute at @p[tag=Denji,scores={Timer=..5}] run scoreboard players add @p[tag=Denji,scores={Basic_Attack=1..}] Timer 1
execute at @a[tag=Denji,tag=DenjiChainsaw,scores={Basic_Attack=1..}] run playsound minecraft:entity.bee.hurt neutral @a[distance=..10] ~ ~ ~ 3 0 1
execute at @a[tag=Denji,tag=DenjiChainsaw,scores={Basic_Attack=1..}] run particle minecraft:crit ^ ^1.1 ^2 0.5 0 0.5 0 20

# Groin Kick
scoreboard players add @p[tag=Denji,scores={Ability1CD=..99}] Ability1CD 1
execute as @p[tag=Denji,tag=!DenjiChainsaw,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Devil\'s Chainsaw","italic":false,"color":"red"}]'}}}}] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/weapon1cos

# Chain Wrap
execute as @p[tag=Denji,tag=DenjiChainsaw,scores={Ability1CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Devil\'s Chainsaw","italic":false,"color":"red"}]'}}}}] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/weapon1cos2
...
execute at @e[type=area_effect_cloud,tag=chainsawchain] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Denji,tag=!InLabyrinth] at @s run function datapack:chainsawman_functions/chains
execute as @e[type=area_effect_cloud,tag=chainsawchain] at @s if entity @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Denji,tag=!InLabyrinth] run kill @s
...
execute if entity @e[tag=DenjiChained,limit=1] as @p[tag=Denji,tag=DenjiChainsaw,scores={Ability1CD=10..99},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Devil\'s Chainsaw","italic":false,"color":"red"}]'}}}}] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/chainpull 
...
# Cord
execute as @p[tag=Denji,scores={Timer=5..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Devil\'s Chainsaw","italic":false,"color":"red"}]'}}}}] as @p[tag=Denji,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:chainsawman_functions/weapon1shift
...
item replace entity @p[tag=Denji,scores={Timer2=300..}] armor.head with minecraft:player_head{display:{Name:"{\"text\":\"Denji\"}"},SkullOwner:{Id:[I;-962959391,1296255494,-2011161131,-1320338836],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzUwODIzYzU3YjRlMTY3NjMxMWRkY2Q4ZTUyOTcxOGM4ZTE5MDhjYmFiMjdmYTNlNzIxYzkxMWVmM2ExY2QzZCJ9fX0="}]}}} 1
