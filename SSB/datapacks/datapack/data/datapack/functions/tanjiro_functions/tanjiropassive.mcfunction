...
execute as @p[tag=Tanjiro,scores={Basic_Shift=1..},gamemode=!spectator] as @p[tag=Tanjiro,scores={Ability1CD=200..},nbt={SelectedItem:{id:"minecraft:iron_sword",tag:{display:{Name:'[{"text":"Nichirin Blade","italic":false}]'}}}}] at @s run function datapack:tanjiro_functions/weapon1shift
...
execute as @p[tag=Tanjiro,scores={Basic_COS=1..}] as @p[tag=Tanjiro,tag=!TanjiroFiregod,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Water Breathing","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:tanjiro_functions/waterwheel

execute as @p[tag=Tanjiro,scores={Basic_COS=1..}] as @p[tag=Tanjiro,tag=TanjiroFiregod,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Water Breathing","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:tanjiro_functions/clearbluesky

# Water Surface Slash
scoreboard players add @p[tag=Tanjiro,scores={Ability3CD=..49}] Ability3CD 1
execute as @p[tag=Tanjiro,scores={Basic_Shift=1..},gamemode=!spectator] as @p[tag=Tanjiro,tag=!TanjiroFiregod,scores={Ability3CD=50..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Water Breathing","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:tanjiro_functions/watersurfaceslash

execute as @p[tag=Tanjiro,scores={Basic_Shift=1..},gamemode=!spectator] as @p[tag=Tanjiro,tag=TanjiroFiregod,scores={Ability3CD=50..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Water Breathing","italic":false,"color":"dark_aqua"}]'}}}}] at @s run function datapack:tanjiro_functions/ragingsun 

# Firegod
scoreboard players add @p[tag=Tanjiro,scores={Ability4CD=..699}] Ability4CD 1
execute as @p[tag=Tanjiro,scores={Basic_COS=1..}] as @p[tag=Tanjiro,scores={Ability4CD=700..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Dance of the Fire God","italic":false,"color":"gold"}]'}}}}] at @s run function datapack:tanjiro_functions/firegod
