...
# Dancing Blade
scoreboard players add @p[tag=Lucina,scores={Basic_IronSword=1..}] Timer 1
...
execute at @p[tag=LucinaDancingBlade,scores={Basic_IronSword=1..}] run function datapack:lucina_functions/dancingbladeparticles
execute at @p[tag=LucinaDancingBlade,scores={Timer=5..}] as @e[distance=..10,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Lucina,tag=!InLabyrinth,nbt={HurtTime:10s}] at @s run function datapack:lucina_functions/dancingbladedamage
...
execute as @p[gamemode=!spectator,tag=Lucina,scores={Ability1CD=200..},nbt={SelectedItem:{id:"minecraft:iron_sword",tag:{Unbreakable:1,display:{Name:'[{"text":"Parallel Falchion","italic":false,"color":"aqua"}]'}}}}] as @p[tag=Lucina,scores={Basic_Shift=1..}] at @s run function datapack:lucina_functions/weapon1shift
...
execute at @p[tag=Lucina,scores={Basic_IronSword=1..},nbt={ActiveEffects:[{Id:5b}]}] run execute at @e[distance=..10,limit=1,sort=nearest,tag=!Lucina,tag=!InLabyrinth,nbt={HurtTime:10s}] run particle minecraft:block minecraft:redstone_block ~ ~1 ~ 0.4 1 0.4 0 30
execute at @p[tag=Lucina,scores={Basic_IronSword=1..},nbt={ActiveEffects:[{Id:5b}]}] run playsound minecraft:entity.player.attack.crit neutral @a[distance=..25] ~ ~ ~ 10 0.75 1
effect clear @p[tag=Lucina,scores={Basic_IronSword=1..},nbt={ActiveEffects:[{Id:5b}]}] minecraft:strength

# Critical Hit
scoreboard players add @p[tag=Lucina,scores={Ability2CD=..99}] Ability2CD 1
execute as @p[tag=Lucina,scores={Ability2CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Lucina\'s Skills","italic":false,"color":"dark_aqua"}]'}}}}] as @p[tag=Lucina,scores={Basic_COS=1..}] at @s run function datapack:lucina_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Lucina,scores={Ability3CD=100..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{Unbreakable:1,display:{Name:'[{"text":"Lucina\'s Skills","italic":false,"color":"dark_aqua"}]'}}}}] as @p[tag=Lucina,scores={Basic_Shift=1..}] at @s run function datapack:lucina_functions/weapon2shift