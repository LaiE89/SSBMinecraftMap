...
execute as @p[tag=Luffy,gamemode=!spectator,scores={Basic_Shift=1..}] as @p[tag=Luffy,scores={Ability1CD=100..},predicate=datapack:luffy_items/fist] at @s run function datapack:luffy_functions/weapon1shift
...
execute as @p[tag=Luffy,scores={Basic_COS=1..}] as @p[tag=Luffy,scores={Ability2CD=100..},predicate=datapack:luffy_items/fist] at @s run function datapack:luffy_functions/weapon1cos

# Gatling
scoreboard players add @p[tag=Luffy,scores={Ability3CD=..199}] Ability3CD 1
execute as @p[tag=Luffy,scores={Basic_COS=1..}] as @p[tag=Luffy,scores={Ability3CD=200..},predicate=datapack:luffy_items/skills] at @s run function datapack:luffy_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Luffy,scores={Basic_Shift=1..}] as @p[tag=Luffy,scores={Ability4CD=200..},predicate=datapack:luffy_items/skills] at @s run function datapack:luffy_functions/weapon2shift
