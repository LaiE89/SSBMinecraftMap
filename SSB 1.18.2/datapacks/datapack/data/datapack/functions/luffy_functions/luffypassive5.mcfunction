...
execute as @s[scores={RaycastTimer=2222..3000}] positioned ^ ^ ^ run summon armor_stand ~ ~ ~ {Tags:["LuffyPistolDestination"],Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1,DisabledSlots:2039583}
execute if entity @s[scores={RaycastTimer=31}] run summon armor_stand ~ ~ ~ {Tags:["LuffyPistolDestination"],Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1,DisabledSlots:2039583}
