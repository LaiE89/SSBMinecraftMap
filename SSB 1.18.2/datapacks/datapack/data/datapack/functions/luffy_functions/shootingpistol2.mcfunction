...
execute at @e[tag=ChargingLuffyPistol,type=armor_stand] run summon armor_stand ~ ~ ~ {Tags:["LuffyPistolAngle"],Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1,DisabledSlots:2039583}
