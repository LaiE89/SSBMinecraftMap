...
execute as @p[tag=Jax,scores={Ability3CD=200..},predicate=datapack:jax_items/unit] as @p[tag=Jax,scores={Basic_COS=1..}] at @s run function datapack:jax_functions/weapon2cos
...
execute as @p[tag=Jax,scores={Ability4CD=400..},predicate=datapack:jax_items/unit] as @p[gamemode=!spectator,tag=Jax,scores={Basic_Shift=1..}] at @s run function datapack:jax_functions/weapon2shift

# Leapstrike
scoreboard players add @p[tag=Jax,scores={Ability2CD=..99}] Ability2CD 1
execute as @p[tag=Jax,scores={Ability2CD=100..},predicate=datapack:jax_items/lamp] as @p[tag=Jax,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:jax_functions/weapon1shift
...
execute as @p[tag=Jax,scores={Ability1CD=40..},tag=!JaxEmpowered] as @p[tag=Jax,scores={Basic_COS=1..},predicate=datapack:jax_items/lamp] at @s run function datapack:jax_functions/weapon1cos
