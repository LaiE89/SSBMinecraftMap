...
execute as @p[gamemode=!spectator,tag=Darius,scores={Basic_Shift=1..},predicate=datapack:darius_items/axe] as @p[tag=Darius,scores={Ability1CD=80..}] at @s run function datapack:darius_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Darius,scores={Ability2CD=150..},predicate=datapack:darius_items/skills] as @p[tag=Darius,scores={Basic_COS=1..}] at @s run function datapack:darius_functions/weapon2cos

# Crippling Strike
scoreboard players add @e[tag=Darius,scores={Ability3CD=..69}] Ability3CD 1
execute as @p[tag=Darius,scores={Ability3CD=70..},predicate=datapack:darius_items/axe] as @p[tag=Darius,scores={Basic_COS=1..}] at @s run function datapack:darius_functions/weapon1shift
...
execute as @p[tag=Darius,scores={Ability4CD=350..},predicate=datapack:darius_items/skills] as @p[tag=Darius,scores={Basic_Shift=1..}] at @s run function datapack:darius_functions/weapon2shift
