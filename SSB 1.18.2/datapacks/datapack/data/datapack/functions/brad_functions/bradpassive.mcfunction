...
execute as @p[tag=Brad,scores={Basic_COS=1..}] as @p[tag=Brad,scores={Ability1CD=30..},predicate=datapack:brad_items/wristbands] at @s run function datapack:brad_functions/weapon1cos

scoreboard players add @p[tag=Brad,scores={Ability2CD=..29}] Ability2CD 1
execute as @p[gamemode=!spectator,tag=Brad,scores={Basic_Shift=1..}] as @p[tag=Brad,scores={Ability2CD=30..},predicate=datapack:brad_items/wristbands] at @s run function datapack:brad_functions/weapon1shift
...
execute as @p[tag=Brad,scores={Timer8=2}] as @p[tag=Brad,scores={Timer7=1}] at @s run summon area_effect_cloud ^ ^ ^1 {Tags:["BradsFireball","projectile"],Duration:40}
execute as @e[type=area_effect_cloud,tag=BradsFireball,tag=!castedBradsFireball] at @s run tp @s ~ ~ ~ facing entity @p[tag=Brad]
tag @e[type=area_effect_cloud,tag=BradsFireball,tag=!castedBradsFireball] add castedBradsFireball
execute as @e[type=area_effect_cloud,tag=BradsFireball] at @s run tp @s ^ ^ ^-0.8
execute as @e[type=area_effect_cloud,tag=BradsFireball] at @s run particle minecraft:dust 1 0.5 0 0.75 ~ ~1.3 ~ 0.2 0.2 0.2 0.05 100
# particle minecraft:dust 1 0.5 0 3 ~ ~1.3 ~ 0.1 0.1 0.1 0.05 30
execute at @e[type=area_effect_cloud,tag=BradsFireball] as @e[distance=..2,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brad,tag=!InLabyrinth] at @s run function datapack:brad_functions/fireball
