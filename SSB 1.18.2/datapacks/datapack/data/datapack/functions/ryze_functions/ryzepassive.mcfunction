...
execute as @p[gamemode=!spectator,tag=Ryze,scores={Ability2CD=100..}] as @p[tag=Ryze,scores={Timer2=15..}] as @p[scores={Basic_Shift=1..},predicate=datapack:ryze_items/scroll] at @s run function datapack:ryze_functions/weapon2shift
...
execute as @p[tag=Ryze,scores={Ability1CD=80..},gamemode=!spectator,predicate=datapack:ryze_items/book] as @p[tag=Ryze,scores={Basic_COS=1..}] at @s run function datapack:ryze_functions/weapon1cos
...
execute as @e[type=area_effect_cloud,tag=overload] at @s run tp @s ^ ^ ^2

execute at @e[type=area_effect_cloud,tag=overload] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ryze,tag=!InLabyrinth] at @s run function datapack:ryze_functions/overloaddamage
execute as @e[type=area_effect_cloud,tag=overload] at @s run particle minecraft:dust 0 0.5 1 0.5 ~ ~1 ~ 0.2 0.2 0.2 0.05 200
#execute as @e[type=area_effect_cloud,tag=overload] at @s run particle minecraft:bubble_pop ~ ~1 ~ 0.2 0.2 0.2 0 50
...
execute as @p[gamemode=!spectator,tag=Ryze,scores={Ability3CD=20..}] as @p[tag=Ryze,scores={Timer2=10..}] as @p[scores={Basic_COS=1..},predicate=datapack:ryze_items/scroll] at @s run function datapack:ryze_functions/weapon2cos
...
execute as @e[tag=RyzeFlux] at @s if entity @e[type=area_effect_cloud,tag=overloadspread,distance=..2] run function datapack:ryze_functions/fluxspreaddamage
execute as @e[tag=RyzeFluxTarget] at @s if entity @e[type=area_effect_cloud,tag=RyzeFluxBall,distance=..1] run function datapack:ryze_functions/fluxeffects
...
execute as @e[type=area_effect_cloud,tag=RyzeFluxBall] at @s run particle minecraft:dust 0.5 1 1 0.5 ~ ~1 ~ 0.1 0.1 0.1 0.05 100
execute as @e[type=area_effect_cloud,tag=overloadspread] at @s run particle minecraft:dust 0 0.5 1 0.5 ~ ~1 ~ 0.2 0.2 0.2 0.05 200
...
tag @e[tag=RyzeFlux,scores={RyzeFluxTimer=75..}] remove RyzeCurTarget
...
execute at @e[tag=RyzeFlux] run particle minecraft:dust 0 0.8 1 1 ~ ~ ~ 0.5 0 0.5 0 30

execute at @p[tag=Ryze,scores={Timer3=1..}] run particle minecraft:dust 0 1 1 0.5 ^-0.4 ^0.8 ^0.4 0.03 0.03 0.03 1 20
execute at @p[tag=Ryze,scores={Timer3=2..}] run particle minecraft:dust 0 1 1 0.5 ^0.4 ^0.8 ^0.4 0.03 0.03 0.03 1 20

# Realm Warp
scoreboard players add @p[tag=Ryze,scores={Ability4CD=..299}] Ability4CD 1
execute as @p[tag=Ryze,gamemode=!spectator,scores={Basic_Shift=1..}] as @p[tag=Ryze,scores={Ability4CD=300..},predicate=datapack:ryze_items/book] at @s run function datapack:ryze_functions/weapon1shift
