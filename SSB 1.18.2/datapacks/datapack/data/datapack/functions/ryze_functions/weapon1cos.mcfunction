#summon armor_stand ~ ~ ~ {Tags:["overload","projectile"],NoGravity:1b,Marker:1b,Invisible:1,DisabledSlots:2096896,Invulnerable:1,ArmorItems:[{},{},{},{id:"minecraft:light_blue_glazed_terracotta",Damage:3,Count:1b}]}
summon area_effect_cloud ^ ^1.25 ^ {Tags:["overload","projectile"],Duration:10} 
