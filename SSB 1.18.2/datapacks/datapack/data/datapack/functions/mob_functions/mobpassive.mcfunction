...
execute as @p[tag=Mob,scores={Basic_COS=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability2CD=100..},predicate=datapack:mob_items/offensive] at @s run function datapack:mob_functions/weapon1cos

execute at @p[tag=Mob,scores={Basic_COS=1..},tag=Mob100Percent] as @p[tag=Mob,scores={Ability2CD=100..},predicate=datapack:mob_items/offensive] at @s run function datapack:mob_functions/weapon1cos100
...
execute as @p[gamemode=!spectator,tag=Mob,scores={Basic_Shift=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability3CD=200..},predicate=datapack:mob_items/defensive] at @s run function datapack:mob_functions/weapon2shift

execute as @p[tag=Mob,scores={Basic_Shift=1..},gamemode=!spectator,tag=Mob100Percent] as @p[tag=Mob,scores={Ability3CD=200..},predicate=datapack:mob_items/defensive] at @s run function datapack:mob_functions/weapon2shift100
...
execute as @p[tag=Mob,scores={Basic_COS=1..},tag=!Mob100Percent] as @p[tag=Mob,scores={Ability4CD=100..},predicate=datapack:mob_items/defensive] at @s run function datapack:mob_functions/weapon2cos

execute as @p[tag=Mob,scores={Basic_COS=1..},tag=Mob100Percent] as @p[tag=Mob,scores={Ability4CD=100..},predicate=datapack:mob_items/defensive] at @s run function datapack:mob_functions/weapon2cos100