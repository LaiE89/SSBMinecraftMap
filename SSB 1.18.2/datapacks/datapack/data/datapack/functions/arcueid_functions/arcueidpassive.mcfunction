...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Basic_COS=1..},predicate=datapack:arcueid_items/claws] as @p[tag=Arcueid,scores={Ability1CD=100..}] at @s run function datapack:arcueid_functions/weapon1cos

# Red Arcueid
scoreboard players add @e[tag=Arcueid,scores={Ability2CD=..349}] Ability2CD 1
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Basic_Shift=1..},predicate=datapack:arcueid_items/claws] as @p[tag=Arcueid,scores={Ability2CD=350..}] at @s run function datapack:arcueid_functions/weapon1shift
...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Basic_COS=1..},predicate=datapack:arcueid_items/marblephantasm] as @p[tag=Arcueid,scores={Ability3CD=500..}] at @s run function datapack:arcueid_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Arcueid,scores={Basic_Shift=1..},predicate=datapack:arcueid_items/marblephantasm] as @p[tag=Arcueid,scores={Ability4CD=1000..}] at @s run function datapack:arcueid_functions/weapon2shift
