...
execute as @s[scores={RaycastTimer=2222..}] positioned ^ ^ ^ run scoreboard players set @s Ability4CD 1
...
execute if entity @s[scores={RaycastTimer=17}] run scoreboard players set @s Ability4CD 1
execute if entity @s[scores={RaycastTimer=17}] run scoreboard players remove @s Timer7 20

execute as @s[scores={RaycastTimer=..16}] rotated ~ 0 positioned ^ ^ ^0.5 run function datapack:chosenundead_functions/chosenundeadpassive3