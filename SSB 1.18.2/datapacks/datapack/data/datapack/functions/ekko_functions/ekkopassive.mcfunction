...
execute as @p[tag=Ekko,scores={Ability1CD=100..},predicate=datapack:ekko_items/bat] as @p[tag=Ekko,scores={Basic_COS=1..}] at @s run function datapack:ekko_functions/weapon1cos

#execute as @e[type=armor_stand,tag=Winder,tag=!facingEkko,scores={Timer=..40}] at @s run tp @s
...
execute as @p[gamemode=!spectator,tag=Ekko,scores={Ability2CD=100..}] as @p[scores={Basic_Shift=1},predicate=datapack:ekko_items/bat] at @s run function datapack:ekko_functions/weapon1shift
...
execute as @p[gamemode=!spectator,tag=EkkoDiving,tag=Ekko,scores={Basic_Shift=1..},predicate=datapack:ekko_items/bat] at @s run function datapack:ekko_functions/phasediving
...
execute as @p[tag=Ekko,scores={Ability3CD=300},predicate=datapack:ekko_items/zdrive] as @p[tag=Ekko,scores={Basic_COS=1..}] at @s run function datapack:ekko_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Ekko,scores={Ability4CD=500..}] as @p[tag=Ekko,scores={Basic_Shift=1..}] as @p[predicate=datapack:ekko_items/zdrive] at @s run function datapack:ekko_functions/weapon2shift
