...
# Pulse Pistols
execute as @p[tag=Tracer,tag=!TracerReload,tag=!TracerRecall,scores={Ability5CD=1..},predicate=datapack:tracer_items/pistol] as @p[tag=Tracer,scores={Basic_COS=1..}] at @s run function datapack:tracer_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Tracer,tag=!TracerBlinkCD,tag=!TracerRecall,scores={Ability4CD=1..},predicate=datapack:tracer_items/pistol] as @p[tag=Tracer,scores={Basic_Shift=1..}] at @s run function datapack:tracer_functions/weapon1shift
...
execute as @p[tag=Tracer,scores={Ability2CD=300..},predicate=datapack:tracer_items/bomb] as @p[tag=Tracer,scores={Basic_COS=1..}] at @s run function datapack:tracer_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Tracer,tag=!TracerRecall,scores={Ability3CD=500..},predicate=datapack:tracer_items/bomb] as @p[tag=Tracer,scores={Basic_Shift=1..}] at @s run function datapack:tracer_functions/weapon2shift
