...
execute as @p[gamemode=!spectator,tag=Lucina,scores={Ability1CD=200..},predicate=datapack:lucina_items/falchion] as @p[tag=Lucina,scores={Basic_Shift=1..}] at @s run function datapack:lucina_functions/weapon1shift
...
execute as @p[tag=Lucina,scores={Ability2CD=100..},predicate=datapack:lucina_items/skills] as @p[tag=Lucina,scores={Basic_COS=1..}] at @s run function datapack:lucina_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Lucina,scores={Ability3CD=100..},predicate=datapack:lucina_items/skills] as @p[tag=Lucina,scores={Basic_Shift=1..}] at @s run function datapack:lucina_functions/weapon2shift