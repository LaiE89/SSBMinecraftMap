...
execute as @p[tag=Alucard,tag=!AlucardWraith,scores={Basic_COS=1..}] as @p[tag=Alucard,scores={Ability1CD=50..},predicate=datapack:alucard_items/jackal] at @s run function datapack:alucard_functions/weapon1cos
# nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Jackal","italic":false,"color":"dark_red"}]'}}}}
...
execute as @p[tag=Alucard,gamemode=!spectator,scores={Basic_Shift=1..}] as @p[tag=Alucard,scores={Ability2CD=400..},predicate=datapack:alucard_items/dark_arts] at @s run function datapack:alucard_functions/weapon2shift
...
execute as @p[tag=Alucard,tag=!AlucardWraith,gamemode=!spectator,scores={Ability3CD=400..},predicate=datapack:alucard_items/dark_arts] as @p[tag=Alucard,scores={Basic_COS=1..}] at @s run function datapack:alucard_functions/weapon2cos

execute if entity @e[type=armor_stand,tag=baskerville] as @p[gamemode=!spectator,tag=Alucard,scores={Ability3CD=20..150},predicate=datapack:alucard_items/dark_arts] as @p[tag=Alucard,scores={Basic_COS=1..}] at @s run function datapack:alucard_functions/baskervilleteleport
# nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Alucard's Dark Arts\",\"italic\":false,\"color\":\"dark_red\"}]"}}}}
...
execute as @p[gamemode=!spectator,tag=Alucard,tag=!AlucardWraith,scores={Ability4CD=25..},predicate=datapack:alucard_items/jackal] as @p[tag=Alucard,scores={Basic_Shift=1..}] as @p[tag=Alucard,scores={Timer2=3..}] at @s run function datapack:alucard_functions/weapon1shift
