...
execute as @p[gamemode=!spectator,tag=Ness,tag=!NessInThunder,scores={Basic_Shift=1..},tag=!NessPKFlash] as @p[tag=Ness,scores={Ability1CD=100..},predicate=datapack:ness_items/bat] at @s run function datapack:ness_functions/weapon1shift
...
execute as @p[tag=Ness,scores={Basic_COS=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability2CD=100..},predicate=datapack:ness_items/pk] at @s run function datapack:ness_functions/weapon2cos

execute as @e[type=area_effect_cloud,tag=pkfire,tag=!facingpkfire] at @s run tp @s ~ ~ ~ facing entity @p[tag=Ness]
tag @e[type=area_effect_cloud,tag=pkfire,tag=!facingpkfire] add facingpkfire
execute as @e[type=area_effect_cloud,tag=pkfire] at @s run tp @s ^ ^ ^-2
execute as @e[type=area_effect_cloud,tag=pkfire] at @s run particle minecraft:flame ~ ~1 ~ 0 0 0 0 10
execute as @e[type=area_effect_cloud,tag=pkfire] at @s if entity @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Ness,tag=!InLabyrinth] run function datapack:ness_functions/pkfiredamage
...
execute as @p[gamemode=!spectator,tag=Ness,scores={Basic_Shift=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability3CD=200..},predicate=datapack:ness_items/pk] at @s run function datapack:ness_functions/weapon2shift
...
execute as @p[gamemode=!spectator,tag=Ness,scores={Basic_Shift=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability4CD=200..},predicate=datapack:ness_items/psi] at @s run function datapack:ness_functions/weapon3shift
...
execute as @p[tag=Ness,scores={Basic_COS=1..},tag=!NessInThunder,tag=!NessPKFlash] as @p[tag=Ness,scores={Ability5CD=200..},predicate=datapack:ness_items/psi] at @s run function datapack:ness_functions/weapon3cos