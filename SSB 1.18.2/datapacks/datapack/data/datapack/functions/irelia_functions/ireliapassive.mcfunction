...
execute as @p[tag=Irelia,tag=!IreliaDefiantDance,scores={Ability1CD=100..},predicate=datapack:irelia_items/blades] as @s[tag=Irelia,scores={Basic_COS=1..}] at @s run function datapack:irelia_functions/weapon1cos
...
execute as @p[gamemode=!spectator,tag=Irelia,tag=!IreliaBladesurging,scores={Ability2CD=300..},predicate=datapack:irelia_items/blades] as @s[tag=Irelia,scores={Basic_Shift=1..}] at @s run function datapack:irelia_functions/weapon1shift
...
execute as @p[tag=Irelia,tag=IreliaDefiantDance,scores={Timer2=10..},predicate=datapack:irelia_items/blades] as @s[tag=Irelia,scores={Basic_Shift=1..}] at @s run scoreboard players set @s Timer2 44

# Flawless Duet
scoreboard players add @p[tag=Irelia,scores={Ability3CD=..149}] Ability3CD 1
execute as @p[tag=Irelia,tag=!IreliaDefiantDance,scores={Ability3CD=150..},predicate=datapack:irelia_items/skills] as @s[tag=Irelia,scores={Basic_COS=1..}] at @s run function datapack:irelia_functions/weapon2cos

scoreboard players add @p[tag=IreliaFlawlessDuet,scores={Timer=..69}] Timer 1
execute as @p[tag=IreliaFlawlessDuet,scores={Timer=2..},predicate=datapack:irelia_items/skills] as @s[tag=Irelia,scores={Basic_COS=1..}] at @s run function datapack:irelia_functions/weapon2cos2
...
execute as @p[gamemode=!spectator,tag=Irelia,tag=!IreliaDefiantDance,scores={Ability4CD=700..},predicate=datapack:irelia_items/skills] as @s[tag=Irelia,scores={Basic_Shift=1..}] at @s run function datapack:irelia_functions/weapon2shift
