...
execute as @p[tag=Genji,scores={Basic_COS=1..},predicate=datapack:genji_items/shurikens] as @p[tag=Genji,scores={Ability1CD=50..}] at @s run function datapack:genji_functions/weapon1cos

execute as @e[type=area_effect_cloud,tag=GenjiShurikens,tag=!facingGenjiShurikens] at @s run tp @s ~ ~ ~ facing entity @p[tag=Genji]
tag @e[type=area_effect_cloud,tag=GenjiShurikens,tag=!facingGenjiShurikens] add facingGenjiShurikens
execute as @e[type=area_effect_cloud,tag=GenjiShurikens] at @s run tp @s ^ ^ ^-1
execute as @e[type=area_effect_cloud,tag=GenjiShurikens] at @s run particle minecraft:electric_spark ~ ~1 ~
execute as @e[type=area_effect_cloud,tag=GenjiShurikens] at @s as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Genji,tag=!InLabyrinth] at @s run function datapack:genji_functions/shurikendamage
...
execute as @p[tag=Genji,scores={Basic_COS=1..},predicate=datapack:genji_items/skills] as @p[tag=Genji,scores={Ability2CD=100..}] at @s run function datapack:genji_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Genji,scores={Basic_Shift=1..},predicate=datapack:genji_items/skills] as @p[tag=Genji,scores={Ability3CD=150..}] at @s run function datapack:genji_functions/weapon2shift
...
execute as @p[tag=Genji,scores={Basic_COS=1..},predicate=datapack:genji_items/dragonblade] as @p[tag=Genji,scores={Ability4CD=800..}] at @s run function datapack:genji_functions/weapon3cos
...
# Double Jump
execute as @p[gamemode=!spectator,tag=Genji,nbt={OnGround:0b}] as @p[tag=Genji,scores={Basic_Shift=1..},predicate=datapack:genji_items/shurikens] at @s run tag @s add GenjiDoubleJumping
execute as @p[gamemode=!spectator,tag=Genji,nbt={OnGround:0b}] as @p[tag=Genji,scores={Basic_Shift=1..},predicate=datapack:genji_items/real_dragonblade] at @s run tag @s add GenjiDoubleJumping
