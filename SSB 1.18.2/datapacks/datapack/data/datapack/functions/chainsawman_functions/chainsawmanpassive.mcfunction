...
execute as @p[tag=Denji,tag=!DenjiChainsaw,scores={Ability1CD=100..},predicate=datapack:chainsawman_items/chainsaw] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/weapon1cos

# Chain Wrap
execute as @p[tag=Denji,tag=DenjiChainsaw,scores={Ability1CD=100..},predicate=datapack:chainsawman_items/chainsaw] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/weapon1cos2
...
execute if entity @e[tag=DenjiChained,limit=1] as @p[tag=Denji,tag=DenjiChainsaw,scores={Ability1CD=10..99},predicate=datapack:chainsawman_items/chainsaw] as @p[tag=Denji,scores={Basic_COS=1..}] at @s run function datapack:chainsawman_functions/chainpull 
...
# Cord
execute as @p[tag=Denji,scores={Timer=5..},predicate=datapack:chainsawman_items/chainsaw] as @p[tag=Denji,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:chainsawman_functions/weapon1shift
