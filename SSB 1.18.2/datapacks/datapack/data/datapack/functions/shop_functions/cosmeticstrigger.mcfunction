...
execute as @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:"[{\"text\":\"Molester Kill Messages\",\"italic\":false,\"color\":\"light_purple\"}]"}}}}] at @s run function datapack:shop_functions/cosmetics/kill_messages/molester_kill/trigger
