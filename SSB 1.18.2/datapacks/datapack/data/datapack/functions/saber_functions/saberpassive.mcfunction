...
execute as @p[tag=Saber,scores={Ability1CD=150..},predicate=datapack:saber_items/air] as @p[tag=Saber,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:saber_functions/weapon1shift
...
execute as @p[tag=SaberStrikeAir,scores={Timer=15..}] as @p[tag=SaberStrikeAir,gamemode=!spectator,scores={Basic_Shift=1..},predicate=datapack:saber_items/air] at @s run function datapack:saber_functions/strikeair
execute as @p[scores={Timer=15..}] as @p[gamemode=!spectator,scores={Basic_Shift=1..},predicate=datapack:saber_items/air] at @s run scoreboard players reset @s Timer
...
execute as @p[tag=SaberStrikeAir2,scores={Timer2=15..}] as @p[tag=SaberStrikeAir2,gamemode=!spectator,scores={Basic_Shift=1..},predicate=datapack:saber_items/air] at @s run function datapack:saber_functions/strikeair2
execute as @p[scores={Timer2=15..}] as @p[gamemode=!spectator,scores={Basic_Shift=1..},predicate=datapack:saber_items/air] at @s run scoreboard players reset @s Timer2
...
execute as @p[tag=Saber,scores={Ability2CD=150..},predicate=datapack:saber_items/avalon] as @p[tag=Saber,scores={Basic_COS=1..}] at @s run function datapack:saber_functions/weapon2cos

# Avalon
scoreboard players add @p[tag=Saber,scores={Ability3CD=..299}] Ability3CD 1
execute as @p[tag=Saber,scores={Ability3CD=300..},predicate=datapack:saber_items/avalon] as @p[tag=Saber,gamemode=!spectator,scores={Basic_Shift=1..}] at @s run function datapack:saber_functions/weapon2shift

# Excalibur
scoreboard players add @p[tag=Saber,scores={Ability4CD=..599}] Ability4CD 1
execute as @p[tag=Saber,scores={Ability4CD=600..},predicate=datapack:saber_items/excalibur] as @p[tag=Saber,scores={Basic_COS=1..}] at @s run function datapack:saber_functions/weapon3cos

execute as @p[tag=Saber,scores={Timer3=20..}] as @p[gamemode=!spectator,tag=Saber,tag=SaberExcalibur,scores={Basic_Shift=1..},predicate=datapack:saber_items/real_excalibur] at @s run function datapack:saber_functions/excaliburuse
