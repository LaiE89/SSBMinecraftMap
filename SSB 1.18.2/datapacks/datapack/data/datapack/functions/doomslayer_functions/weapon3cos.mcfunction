summon armor_stand ^ ^ ^0.5 {Tags:["bfg","projectile"],DisabledSlots:2039583,NoGravity:1b,Marker:1b,Invisible:1,Small:1,Invulnerable:1,ArmorItems:[{},{},{},{id:"minecraft:lime_glazed_terracotta",Count:1b}]}
