...
execute as @p[tag=Brucelee,scores={Ability1CD=100},predicate=datapack:brucelee_items/nunchucks] as @p[tag=Brucelee,scores={Basic_COS=1..}] at @s run function datapack:brucelee_functions/weapon1cos

execute as @e[type=area_effect_cloud,tag=WATA,tag=!facingWATA] at @s run tp @s ~ ~ ~ facing entity @p[tag=Brucelee]
tag @e[type=area_effect_cloud,tag=WATA,tag=!facingWATA] add facingWATA
execute as @e[type=area_effect_cloud,tag=WATA] at @s run tp @s ^ ^ ^-2
execute as @e[type=area_effect_cloud,tag=WATA] at @s run particle minecraft:dust 0 0.75 1 0.5 ~ ~1 ~ 0.05 0.05 0.05 0.05 50
execute as @e[type=area_effect_cloud,tag=WATA] at @s run particle minecraft:dripping_water ~ ~1 ~ 0 0 0 0 1
execute at @e[type=area_effect_cloud,tag=WATA] as @e[distance=..2,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brucelee,tag=!InLabyrinth] at @s run function datapack:brucelee_functions/watadamage
...
execute as @p[tag=Brucelee,scores={Ability2CD=150..},predicate=datapack:brucelee_items/persistence] as @p[tag=Brucelee,scores={Basic_COS=1..}] at @s run function datapack:brucelee_functions/weapon2cos
...
execute as @p[gamemode=!spectator,tag=Brucelee,scores={Ability3CD=300..},predicate=datapack:brucelee_items/persistence] as @p[tag=Brucelee,scores={Basic_Shift=1..}] at @s run function datapack:brucelee_functions/weapon2shift
...
execute as @p[gamemode=!spectator,tag=Brucelee,scores={Ability4CD=100..},predicate=datapack:brucelee_items/nunchucks] as @p[tag=Brucelee,scores={Basic_Shift=1..}] at @s run function datapack:brucelee_functions/weapon1shift

# Dragon Kick
scoreboard players add @p[tag=Brucelee,scores={Ability5CD=..299}] Ability5CD 1
execute as @p[tag=Brucelee,scores={Ability5CD=300..},predicate=datapack:brucelee_items/dragon_kick] as @p[tag=Brucelee,scores={Basic_COS=1..}] at @s as @e[distance=..6,limit=1,sort=nearest,type=!experience_orb,type=!area_effect_cloud,type=!armor_stand,type=!egg,type=!leash_knot,type=!trident,type=!painting,type=!#arrows,type=!snowball,type=!fireball,type=!small_fireball,type=!ender_pearl,type=!eye_of_ender,type=!experience_bottle,type=!item_frame,type=!item,type=!tnt,type=!falling_block,type=!firework_rocket,type=!shulker_bullet,type=!dragon_fireball,type=!evoker_fangs,type=!minecart,type=!chest_minecart,type=!furnace_minecart,type=!tnt_minecart,type=!hopper_minecart,type=!spawner_minecart,type=!llama_spit,tag=!Brucelee,tag=!InLabyrinth] at @s run function datapack:brucelee_functions/weapon3cos
